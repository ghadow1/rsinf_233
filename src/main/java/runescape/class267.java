...
public class class267 {
   ...
   static void method6042(class461 var1, class461 var2) {
      int var5;
      int var33;
      int var34;
      boolean var43;
      if (class52.field740) {
         ...
         while(true) {
            if (!var4.method6121()) {
               if (class35.lastButton != 1 && (class423.field5058 || class35.lastButton != 4)) {
                  break;
               }
               ...
               if (class52.field748 != -1) {
                  ...
                  var43 = class505.method10134(client.field385, class582.field5865);
                  boolean var44 = var36.method1470();
                  class509.isBetaBuild = var44;
         ...
         if ((class35.lastButton == 1 || !class423.field5058 && class35.lastButton == 4) && class35.field221 >= class52.field731 + 765 - 50 && class35.field224 >= 453 && class35.field221 < class52.field731 + 765 && class35.field224 < 503) {
            class36.clientPreferences.method2560(!class36.clientPreferences.method2559());
               ...
               if (class52.field758 == 0) {
                  ...
                  if (class52.field758 == 2) {
                     ...
                     if (var5 == 1 && class52.field727) {
                        ...
                        if (!client.Login_isUsernameRemembered && class36.clientPreferences.method2597() != null) {
                           class36.clientPreferences.method2588((String)null);
                        }
                     }
                     ...
                     if (var5 == 1 && class52.field749) {
                        class36.clientPreferences.method2558(!class36.clientPreferences.method2557());
                        if (!class36.clientPreferences.method2557()) {
                           class52.local_username = "";
                           class36.clientPreferences.method2588((String)null);
                                 ...
                                 while(true) {
                                    while(var9.method6121()) {
                                       if (var9.field3212 != 13) {
                                          ...
                                          if (var9.field3212 == 85 && !class52.local_username.isEmpty()) {
                                             class52.local_username = class52.local_username.substring(0, class52.local_username.length() - 1);
                                          }
                                          ...
                                          if (var40 && class52.local_username.length() < 320) {
                                             class52.local_username = class52.local_username + var9.field3215;
                                          }
                                       } else {
                                          class78.method2677(0);
                                          class52.local_username = "";

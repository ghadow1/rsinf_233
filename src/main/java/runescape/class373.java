...
public class class373 extends class371 {
   ...
   static final void method8141(class79 var0, PacketBuffer var1) {
      for(int var2 = 0; var2 < client.field468; ++var2) {
         ...
         if ((var5 & 16) != 0) {
            var4.field1184 = class63.method2129(var1.readUnsignedShort());
         ...
         if ((var5 & 8192) != 0) {
            ...
            var4.field1085 = var1.method11241() + client.cycle;
            var4.field1094 = var1.method11422() + client.cycle;
         ...
         if ((var5 & 4096) != 0) {
            var4.field1051 = client.cycle + var1.method11422();
            var4.field1052 = client.cycle + var1.method11241();
         ...
         if ((var5 & 65536) != 0) {
            var6 = var1.method11295();
            var4.field1064 = (var6 & 1) != 0 ? var1.readUnsignedShort() : var4.field1184.field2108;
            ...
            var4.field1065 = (var6 & 256) != 0 ? var1.readUnsignedShort() : var4.field1184.field2155;
            ...
            var4.field1061 = (var6 & 4096) != 0 ? var1.readUnsignedShort() : var4.field1184.field2115;
            var4.field1105 = (var6 & 8192) != 0 ? var1.readUnsignedShort() : var4.field1184.field2122;
         ...
         if ((var5 & 4) != 0) {
            ...
            if (var6 > 0) {
               for(var18 = 0; var18 < var6; ++var18) {
                  ...
                  var4.method2425(var8, var10, var9, var11, client.cycle, var12);
               }
            }
            ...
            if (var18 > 0) {
               for(var8 = 0; var8 < var18; ++var8) {
                  ...
                  if (var10 != 32767) {
                     ...
                     var4.method2454(var9, client.cycle, var10, var11, var12, var13);
                  } else {
         ...
         if ((var5 & 512) != 0) {
            var4.field1106 = var1.method11295();
         }

...
public class class231 extends class238 {
   ...
   static void method5359(int var0, int var1, int var2, int var3, Object[] var4) {
      ...
      if (var5 || var6 != null) {
         ...
         class329 var16 = EnumComposition.getPacketBufferNode(ClientPackets.field3579, client.packetWriter.isaacCipher);
         var16.out.writeShortBigEndian(0);
         var8 = var16.out.offset * 1216585693;
         var16.out.putIntLittleEndian(var3);
         var16.out.writeIntBigEndian(var0);
         var16.out.writeIntME(var2);
         var16.out.method11325(var1);
         Object[] var9 = var4;

         for(int var10 = 0; var10 < var9.length; ++var10) {
            Object var11 = var9[var10];
            if (var11 instanceof Integer) {
               var16.out.method11443((Integer)var11);
            } else if (var11 instanceof String) {
               var16.out.writeNullTermString((String)var11);
            } else if (var11 instanceof class519) {
               class519 var12 = (class519)var11;
               int var13 = var12.method10322();
               var16.out.method11192(var13);
               int var15;
               if (var12.field5504 == class574.field5820) {
                  int[] var17 = var12.method10318();

                  for(var15 = 0; var15 < var13; ++var15) {
                     var16.out.method11443(var17[var15]);
                  }
               } else {
                  Object[] var14 = var12.method10321();

                  for(var15 = 0; var15 < var13; ++var15) {
                     var16.out.writeNullTermString((String)var14[var15]);
                  }
               }
            } else if (var11 == null) {
               var16.out.writeByte(0);
            }
         }

         var16.out.putUnsignedShortBigEndian(var16.out.offset * 1216585693 - var8);

...
public class class368 {
   ...
   int field4129;
   @ObfuscatedName("aq")
   int[] field4126 = new int[32];
   @ObfuscatedName("ao")
   int[] field4130 = new int[32];
   @ObfuscatedName("as")
   @ObfuscatedGetter(
      intValue = 1734592813
   )
   ...
   public void method7917(int var1, class369 var2, int var3) {
      this.field4128 = var2;
      this.field4129 = 0;
      this.field4132 = 0;
      if (var1 >= 0 && var1 < 3) {
         if (var2 == null || var2.field4145 * -217986249 == -1 && var2.field4147 == 0) {
            if (var2 != null && var2.field4286 != null) {
               if (var1 == 0) {
                  class369[] var7 = var2.field4286;

                  for(int var5 = 0; var5 < var7.length; ++var5) {
                     class369 var6 = var7[var5];
                     if (var6 != null) {
                        this.method7902(var6.field4145 * -217986249);
                     }
                  }
               } else {
                  boolean var4 = var1 != 1;
                  ...
                  } else if (var3 >= 0 && var3 < var2.field4286.length && var2.field4286[var3] != null) {
                     this.method7929(var2.field4286[var3], var4);
                  }
               }
   ...
   final void method7929(class369 var1, boolean var2) {
      int var3 = var1 == this.field4128 ? 0 : var1.field4248;
      int var4 = var1 == this.field4128 ? var1.field4286.length - 1 : var1.field4214;

      for(int var5 = var3; var5 <= var4; ++var5) {
         class369 var6 = this.field4128.field4286[var5];
         if (var6 != null && var1.field4145 * -217986249 == var6.field4165) {
            this.method7902(var6.field4145 * -217986249);
   ...
   public class369 method7906() {
      int var1 = this.method7919();
      return var1 >= 0 ? this.field4128.field4286[var1] : null;
   }
   ...
   public void method7908(int var1, Object var2, Object var3) {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         class369 var7 = this.field4128.field4286[var4[var6]];
         if (var7 != null) {

...
@ObfuscatedName("nf")
public class class340 extends class104 {
   @ObfuscatedName("ac")
   static AtomicBoolean field3901 = null;
   @ObfuscatedName("ap")
   static ThreadPoolExecutor field3902 = null;
   @ObfuscatedName("aq")
   PriorityQueue field3927 = new PriorityQueue(5, new class350());
   @ObfuscatedName("ao")
   @ObfuscatedGetter(
      intValue = -1703331115
   )
   ...
   @ObfuscatedName("as")
   int[] field3905 = new int[16];
   @ObfuscatedName("al")
   int[] field3928 = new int[16];
   @ObfuscatedName("au")
   int[] field3907 = new int[16];
   @ObfuscatedName("ai")
   @ObfuscatedSignature(
      descriptor = "Lqw;"
   )
   ...
   int field3910 = -727379968;
   @ObfuscatedName("an")
   int[] field3911 = new int[16];
   @ObfuscatedName("ar")
   int[] field3912 = new int[16];
   @ObfuscatedName("ae")
   int[] field3913 = new int[16];
   @ObfuscatedName("ay")
   int[] field3915 = new int[16];
   @ObfuscatedName("ad")
   int[] field3918 = new int[16];
   @ObfuscatedName("ag")
   int[] field3932 = new int[16];
   @ObfuscatedName("av")
   int[] field3917 = new int[16];
   @ObfuscatedName("aj")
   int[] field3916 = new int[16];
   @ObfuscatedName("az")
   int[] field3919 = new int[16];
   @ObfuscatedName("bt")
   int[] field3903 = new int[16];
   @ObfuscatedName("bs")
   int[] field3921 = new int[16];
   @ObfuscatedName("bu")
   int[] field3899 = new int[16];
   @ObfuscatedName("bi")
   @ObfuscatedSignature(
      descriptor = "[[Lno;"
   )
   class349[][] field3923 = new class349[16][128];
   @ObfuscatedName("bd")
   @ObfuscatedSignature(
      descriptor = "[[Lno;"
   )
   class349[][] field3924 = new class349[16][128];
   @ObfuscatedName("ba")
   @ObfuscatedSignature(
      descriptor = "Lnr;"
   )
   class341 field3931 = new class341();
   @ObfuscatedName("bb")
   boolean field3926;
   @ObfuscatedName("bo")
   @ObfuscatedGetter(
   ...
   class347 field3906 = new class347(this);
   @ObfuscatedName("bq")
   @ObfuscatedSignature(
      descriptor = "Ldn;"
   )
   class97 field3922 = null;

   @ObfuscatedSignature(
      descriptor = "(Ldn;)V"
   )
   public class340(class97 var1) {
      this.field3922 = var1;
      this.field3908 = new class428(128);
      this.method7160();
   }
   ...
   public void method7218(int var1) {
   ...
   public boolean method7169(class348 var1, class412 var2, class100 var3) {
      synchronized(this.field3922) {
         boolean var5 = true;
         ...
         for(class352 var6 = (class352)var1.field3974.method8626(); var6 != null; var6 = (class352)var1.field3974.method8627()) {
            int var14 = (int)var6.field5600;
            class344 var8 = (class344)this.field3908.method8623((long)var14);
            if (var8 == null) {
               byte[] var10 = var2.method8425(var14);
               class344 var9;
               if (var10 == null) {
                  var9 = null;
               } else {
                  var9 = new class344(var10);
               }
               ...
               this.field3908.method8625(var9, (long)var14);
            }

            if (!var8.method7328(var3, var6.field4015)) {
               var5 = false;
            } else if (this.field3927 != null) {
               synchronized(this.field3927) {
                  Iterator var18 = var8.field3960.iterator();

                  while(var18.hasNext()) {
                     class108 var11 = (class108)var18.next();
                     this.field3927.add(new class343(var6.field4016, var11));
                  }
               }
            }
         }
   ...
   public void method7142() {
      synchronized(this.field3922) {
         for(class344 var2 = (class344)this.field3908.method8626(); var2 != null; var2 = (class344)this.field3908.method8627()) {
            var2.method7335();
         }
   ...
   protected void vmethod7347(int[] var1, int var2, int var3) {
      if (this.field3931.method7290()) {
         int var4 = this.field3931.field3940 * this.field3910 * 1000000 / class97.field1356;
         ...
         do {
            ...
            this.field3906.vmethod7347(var1, var2, var7);
            var2 += var7;
            var3 -= var7;
            this.method7173();
         } while(this.field3931.method7290());
      }

      this.field3906.vmethod7347(var1, var2, var3);
   }
   ...
   protected void vmethod7348(int var1) {
      if (this.field3931.method7290()) {
         int var2 = this.field3931.field3940 * this.field3910 * 1000000 / class97.field1356;
         ...
         do {
            ...
            this.field3906.vmethod7348(var5);
            var1 -= var5;
            this.method7173();
         } while(this.field3931.method7290());
      }

      this.field3906.vmethod7348(var1);
   }
   ...
   public void method7247(class348 var1, boolean var2) {
      synchronized(this.field3922) {
         this.method7145();
         this.field3931.method7293(var1.field3973);
         this.field3926 = var2;
         this.field3929 = 0L;
         int var4 = this.field3931.method7275();

         for(int var5 = 0; var5 < var4; ++var5) {
            this.field3931.method7269(var5);
            this.field3931.method7276(var5);
            this.field3931.method7301(var5);
         }

         this.field3914 = this.field3931.method7270();
         this.field3925 = this.field3931.field3946[this.field3914];
         this.field3930 = this.field3931.method7280(this.field3925);
      }
   }
   ...
   public boolean method7146() {
      synchronized(this.field3922) {
         return this.field3931.method7290();
      }
   }
   ...
   public boolean method7256() {
      synchronized(this.field3922) {
         return this.field3908.method8624() > 0;
      }
   }
   ...
   void method7151(int var1, int var2, int var3) {
      ...
      if ((this.field3905[var1] & 2) != 0) {
         for(class349 var4 = (class349)this.field3906.field3971.method8691(); var4 != null; var4 = (class349)this.field3906.field3971.method8693()) {
      ...
      class344 var9 = (class344)this.field3908.method8623((long)this.field3918[var1]);
      if (var9 != null) {
         if (var9.field3962[var2] != null) {
            class95 var5 = var9.field3962[var2].method3372();
            if (var5 != null) {
               ...
               if (this.field3928[var1] == 0) {
                  var6.field3994 = class103.method3154(var5, this.method7165(var6), this.method7181(var6), this.method7166(var6));
               } else {
                  var6.field3994 = class103.method3154(var5, this.method7165(var6), 0, this.method7166(var6));
                  this.method7164(var6, var9.field3959[var2] < 0);
               }

               if (var9.field3959[var2] < 0) {
                  var6.field3994.method3173(-1);
               }

               if (var6.field3980 >= 0) {
                  class349 var7 = this.field3924[var1][var6.field3980];
               ...
               this.field3906.field3971.method8689(var6);
   ...
   void method7164(class349 var1, boolean var2) {
      int var3 = var1.field3978.field1322.length;
      int var4;
      if (var2 && var1.field3978.field1321) {
         int var5 = var3 + var3 - var1.field3978.field1323;
         var4 = (int)((long)this.field3928[var1.field3976] * (long)var5 >> 6);
         var3 <<= 8;
         if (var4 >= var3) {
            var4 = var3 + var3 - 1 - var4;
            var1.field3994.method3182();
         }
      } else {
         var4 = (int)((long)var3 * (long)this.field3928[var1.field3976] >> 6);
      }

      var1.field3994.method3158(var4);
   }
   ...
   void method7153(int var1, int var2, int var3) {
      class349 var4 = this.field3923[var1][var2];
      if (var4 != null) {
         this.field3923[var1][var2] = null;
         if ((this.field3905[var1] & 2) != 0) {
            for(class349 var5 = (class349)this.field3906.field3971.method8690(); var5 != null; var5 = (class349)this.field3906.field3971.method8692()) {
   ...
   void method7216(int var1) {
      for(class349 var2 = (class349)this.field3906.field3971.method8690(); var2 != null; var2 = (class349)this.field3906.field3971.method8692()) {
         if (var1 < 0 || var2.field3976 == var1) {
            if (var2.field3994 != null) {
               var2.field3994.method3186(class97.field1356 / 100);
               if (var2.field3994.method3190()) {
                  this.field3906.field3969.method2958(var2.field3994);
               }
   ...
   int method7165(class349 var1) {
      ...
      var4 = (int)((double)(var1.field3978.field1325 * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double)var2) / (double)class97.field1356 + 0.5D);
   ...
   int method7181(class349 var1) {
      class338 var2 = var1.field3990;
      ...
      if (var2.field3878 != null) {
         var4 = var1.field3993;
         var5 = var2.field3878[var1.field3975 * 2 + 1];
         if (var1.field3975 * 2 < var2.field3878.length - 2) {
            var6 = (var2.field3878[var1.field3975 * 2] & 255) << 8;
            var7 = (var2.field3878[var1.field3975 * 2 + 2] & 255) << 8;
            var5 += (var2.field3878[var1.field3975 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6);
         }
   ...
   void method7173() {
      int var1 = this.field3914;
      int var2 = this.field3925;

      long var3;
      for(var3 = this.field3930; var2 == this.field3925; var3 = this.field3931.method7280(var2)) {
         while(var2 == this.field3931.field3946[var1]) {
            this.field3931.method7269(var1);
            int var5 = this.field3931.method7277(var1);
            if (var5 == 1) {
               this.field3931.method7284();
               this.field3931.method7301(var1);
               if (this.field3931.method7282()) {
                  ...
                  this.field3931.method7283(var3);
               }
               break;
            }
            ...
            this.field3931.method7276(var1);
            this.field3931.method7301(var1);
         }

         var1 = this.field3931.method7270();
         var2 = this.field3931.field3946[var1];
      }
   ...
   boolean method7226(class349 var1) {
      if (var1.field3994 == null) {
         if (var1.field3988 >= 0) {
            var1.vmethod10557();
   ...
   boolean method7180(class349 var1, int[] var2, int var3, int var4) {
      var1.field3995 = class97.field1356 / 100;
      if (var1.field3988 < 0 || var1.field3994 != null && !var1.field3994.method3189()) {
         ...
         var1.field3994.method3188(this.method7165(var1));
         class338 var6 = var1.field3990;
         boolean var7 = false;
         ++var1.field3992;
         ...
         if (var6.field3878 != null) {
            ...
            while(var1.field3975 * 2 < var6.field3878.length - 2 && var1.field3993 > (var6.field3878[var1.field3975 * 2 + 2] & 255) << 8) {
               var1.field3975 = var1.field3975 * 4 + 4;
            }

            if (var1.field3975 * 2 == var6.field3878.length - 2 && var6.field3878[var1.field3975 * 2 + 1] == 0) {
               var7 = true;
            }
         }
         ...
         if (var7) {
            var1.field3994.method3186(var1.field3995);
            if (var2 != null) {
               var1.field3994.vmethod7347(var2, var3, var4);
            } else {
               var1.field3994.vmethod7348(var4);
            }

            if (var1.field3994.method3190()) {
               this.field3906.field3969.method2958(var1.field3994);
            }
            ...
            var1.field3994.method3185(var1.field3995, this.method7181(var1), this.method7166(var1));
            return false;
         }
      } else {
         var1.method7374();

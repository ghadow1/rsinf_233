...
public class class290 {
   ...
   void method6533(class212 var1, int var2, int var3, int var4, class298 var5) {
      ...
      var9 = class198.method4395(((Occluder)var10).vmethod6870());
      if (var9.field1998) {
   ...
   void method6587() {
      ...
      while(var1.hasNext()) {
         Occluder var2 = (Occluder)var1.next();
   ...
   void method6510(HashSet var1, int var2, int var3) {
      ...
      while(var4.hasNext()) {
         Occluder var5 = (Occluder)var4.next();
         if (var5.method6864()) {
   ...
   void method6519(int var1, int var2, HashSet var3, int var4) {
      ...
      while(var7.hasNext()) {
         ...
         Occluder var12 = (Occluder)var8.getValue();
   ...
   void method6522(Occluder var1, int var2, int var3, float var4) {
   ...
   void method6524(Occluder var1, class184 var2, int var3, int var4, float var5) {
   ...
   void method6525(int var1, int var2, HashSet var3, int var4) {
      ...
      while(var6.hasNext()) {
         Occluder var7 = (Occluder)var6.next();
         if (var7.method6864()) {

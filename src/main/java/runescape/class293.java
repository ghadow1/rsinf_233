         ...
         if (var12 != null && var3 == var12.field4164 && var4 == var12.field4165 && (var12.method7948() || class373.method8139(var12) != 0 || class388.method8204(var12) != 0 || var12 == client.field536)) {
            ...
            if (var37 || !var12.field4143 || var15 < var17 && var16 < var18) {
               ...
               if (var12.field4168 == 1337) {
                  if (!client.field392 && !client.isMenuOpen && var38) {
                  ...
                  if (var12.field4143) {
                     ...
                     var24 = false;
                     if ((class35.lastButton == 1 || !class423.field5058 && class35.lastButton == 4) && class35.field221 >= var15 && class35.field224 >= var16 && class35.field221 < var17 && class35.field224 < var18) {
                        var24 = true;
                     }
                     ...
                     if (var12.field4236) {
                        ...
                        if (client.field612 != null || client.isMenuOpen) {
                           var24 = false;
                           var39 = false;
                           var38 = false;
                        }
                  ...
                  if (var12.field4147 == 0) {
                     ...
                     if (var12.field4145 * -217986249 == -1) {
                        ...
                        if (var32 != null) {
                           if (var32.field886 == 0 && class35.field231 >= var15 && class35.field220 >= var16 && class35.field231 < var17 && class35.field220 < var18 && !client.isMenuOpen) {

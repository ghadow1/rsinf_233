...
class class489 implements Comparator {
   ...
   public static boolean method9813(class412 var0, int var1) {
      byte[] var2 = var0.method8425(var1);
      if (var2 == null) {
         return false;
      } else {
         class265.method5994(var2);
         return true;
      }
   }
   ...
   static final boolean method9812(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      int var7 = class242.field2965 + var6;
      if (var7 < var0 && var7 < var1 && var7 < var2) {
         return false;
      } else {
         var7 = class242.field2965 - var6;
         if (var7 > var0 && var7 > var1 && var7 > var2) {
            return false;
         } else {
            var7 = class242.field2964 + var6;

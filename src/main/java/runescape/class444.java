...
public class class444 {
   @ObfuscatedName("af")
   static char[] field5143 = new char[64];
   @ObfuscatedName("aw")
   ...
   static final String method8880(int var0, int var1) {
      int var2 = var1 - var0;
      if (var2 < -9) {
         return class134.method3619(16711680);
      } else if (var2 < -6) {
         return class134.method3619(16723968);
      } else if (var2 < -3) {
         return class134.method3619(16740352);
      } else if (var2 < 0) {
         return class134.method3619(16756736);
      } else if (var2 > 9) {
         return class134.method3619(65280);
      } else if (var2 > 6) {
         return class134.method3619(4259584);
      } else if (var2 > 3) {
         return class134.method3619(8453888);
      } else {
         return var2 > 0 ? class134.method3619(12648192) : class134.method3619(16776960);
      }
   }
}

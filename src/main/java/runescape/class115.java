...
public class class115 {
   ...
   static void method3468(int var0, int var1) {
      class329 var2 = EnumComposition.getPacketBufferNode(ClientPackets.field3625, client.packetWriter.isaacCipher);
      var2.out.method11238(var1);
      var2.out.putIntLittleEndian(var0);

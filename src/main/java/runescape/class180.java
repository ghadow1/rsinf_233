...
public class class180 extends class540 {
   ...
   public static void method4161() {
      synchronized(class35.field226) {
         ...
         class35.lastButton = class35.field235;
   ...
   static final void method4162() {
      class329 var0 = EnumComposition.getPacketBufferNode(ClientPackets.field3626, client.packetWriter.isaacCipher);
      var0.out.writeByte(0);

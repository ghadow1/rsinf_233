...
public final class class69 extends class75 {
   ...
   final void method2168(Buffer var1) {
      ...
      super.field1060 = var1.readUnsignedShort();
      if (super.field1060 == 65535) {
         super.field1060 = -1;
      }

      super.field1064 = var1.readUnsignedShort();
      if (super.field1064 == 65535) {
         super.field1064 = -1;
      }

      super.field1062 = super.field1064;
      super.field1063 = var1.readUnsignedShort();
      if (super.field1063 == 65535) {
         super.field1063 = -1;
      }

      super.field1088 = var1.readUnsignedShort();
      if (super.field1088 == 65535) {
         super.field1088 = -1;
      }

      super.field1096 = var1.readUnsignedShort();
      if (super.field1096 == 65535) {
         super.field1096 = -1;
      }

      super.field1066 = var1.readUnsignedShort();
      if (super.field1066 == 65535) {
         super.field1066 = -1;
      }

      super.field1067 = var1.readUnsignedShort();
      if (super.field1067 == 65535) {
         super.field1067 = -1;
      }

      this.field934 = new class613(var1.method11207(), class92.loginType);
      this.method2171();
      this.method2175();
      this.method2220();
      ...
      this.field940 = var1.readUnsignedShort();
      ...
      if (this.field935 == null) {
         ...
         if (var7 == null) {
            ...
            if (!this.field952 && this.field947 != null) {
               if (client.cycle >= this.field943) {
                  this.field947 = null;
               }

               if (client.cycle >= this.field942 && client.cycle < this.field943) {
            ...
            var7.field2941 = true;
            if (super.field1076.method5651() && client.cycle >= super.field1051 && client.cycle < super.field1052) {

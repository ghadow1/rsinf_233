...
public class class88 {
   ...
   final Buffer field1244 = new Buffer(new byte[5000]);
   @ObfuscatedName("as")
   ...
   final void method2850(PacketBuffer var1) {
      this.method2847();
      var1.method11145();
   ...
   void method2839(PacketBuffer var1, int var2) {
   ...
   void method2843(PacketBuffer var1) {
   ...
   void method2858(PacketBuffer var1, int var2, int var3) {
      ...
      if ((var3 & 2048) != 0) {
         ...
         class397 var9 = (class397)class173.findEnumerated(class446.method8926(), var1.method11196());
      ...
      byte var22;
      if ((var3 & 256) != 0) {
         var6 = client.cycle + var1.method11241();
      ...
      if ((var3 & 1024) != 0) {
         var4.field677 = (class280)class173.findEnumerated(class163.method3999(), var1.method11235());
      ...
      if ((var3 & 8192) != 0) {
         ...
         if (var21 == 127) {
            ...
            this.field1246[var2] = (class280)class173.findEnumerated(class163.method3999(), var21);
         }
      }
      ...
      if ((var3 & 512) != 0) {
         ...
         var25 = var1.method11181() + client.cycle;

...
public class class10 {
      ...
      if (var1 != null && var1.vmethod2740()) {
         ...
         if (!var1.field1047.method8743()) {
            ...
            for(class80 var11 = (class80)var1.field1047.method8748(); var11 != null; var11 = (class80)var1.field1047.method8762()) {
               class76 var12 = var11.method2705(client.cycle);
               if (var12 == null) {
                  if (var11.method2706()) {
                     var11.vmethod10557();
                  }
                  ...
                  int var83 = 255;
                  boolean var87 = true;
                  int var88 = client.cycle - var12.field1109;
         ...
         if (var9 && client.cycle == var1.field1087) {
         ...
         if (var9) {
            ...
            if (client.field455 == 1 && client.field456 == var0.field1161.method9787(var2 - var76) && client.cycle % 20 < 10) {
               class343.method7327(var0, var1, var1.vmethod2734() + 15 + var1.method2417());
               if (client.field503 > -1) {
            ...
            if (var82 - var97 <= client.cycle) {
               if (var105 == null) {
                  ...
                  if (client.field503 > -1) {
                     ...
                     var63 = var1.field1044[var102] - client.cycle;
   ...
   public static final void method103(int var0, int var1, int var2, int var3) {
      for(int var4 = 0; var4 < client.rootWidgetCount; ++var4) {
         if (client.rootWidgetPos1[var4] + client.rootWidgetPos3[var4] > var0 && client.rootWidgetPos1[var4] < var0 + var2 && client.rootWidgetPos4[var4] + client.rootWidgetPos2[var4] > var1 && client.rootWidgetPos2[var4] < var3 + var1) {
   ...
   static final void method104() {
      class329 var0 = EnumComposition.getPacketBufferNode(ClientPackets.field3552, client.packetWriter.isaacCipher);

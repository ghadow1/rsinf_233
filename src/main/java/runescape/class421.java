...
public class class421 {
   ...
   public class421(Buffer var1, boolean var2) {
      ...
      this.field5039 = var1.readUnsignedShort();
      this.field5040 = var1.read32BitArray();
      this.field5041 = var1.read32BitArray();
      this.field5042 = var1.read32BitArray();
      this.field5038 = var1.read32BitArray();
   }

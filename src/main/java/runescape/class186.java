...
public class class186 extends class540 {
   ...
   void method4219(Buffer var1, int var2) {
      if (var2 == 1) {
         ...
         if (var2 == 2) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.field2020[var4] = (short)var1.readUnsignedShort();
               this.field2028[var4] = (short)var1.readUnsignedShort();
            }
         } else if (var2 == 41) {
            var3 = var1.method11196();
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.field2029[var4] = (short)var1.readUnsignedShort();
               this.field2030[var4] = (short)var1.readUnsignedShort();
            }
         } else if (var2 >= 60 && var2 < 70) {
            this.field2034[var2 - 60] = var1.readUnsignedShort();
         }
      }

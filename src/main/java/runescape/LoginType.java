...
public class LoginType {
   ...
   static final LoginType field5774 = new LoginType(0, 1, "", "");
   @ObfuscatedName("at")
   @ObfuscatedSignature(
      descriptor = "Lva;"
   )
   static final LoginType field5768 = new LoginType(6, 2, "", "");
   @ObfuscatedName("ac")
   @ObfuscatedSignature(
      descriptor = "Lva;"
   )
   static final LoginType field5777 = new LoginType(4, 3, "", "");
   @ObfuscatedName("ap")
   @ObfuscatedSignature(
      descriptor = "Lva;"
   )
   static final LoginType field5770 = new LoginType(8, 4, "", "");
   @ObfuscatedName("aq")
   @ObfuscatedSignature(
      descriptor = "Lva;"
   )
   static final LoginType field5771 = new LoginType(1, 5, "", "");
   @ObfuscatedName("ao")
   @ObfuscatedSignature(
      descriptor = "Lva;"
   )
   static final LoginType field5772 = new LoginType(3, 6, "", "");
   @ObfuscatedName("as")
   @ObfuscatedSignature(
      descriptor = "Lva;"
   )
   static final LoginType field5766 = new LoginType(5, 7, "", "");
   @ObfuscatedName("al")
   @ObfuscatedSignature(
      descriptor = "Lva;"
   )

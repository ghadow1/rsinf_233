...
public class class358 {
   ...
   public class358(class412 var1, class412 var2, class412 var3, class412 var4, class412 var5) {
      this.field4040 = new class490(10, Players.field5351);
      this.field4041 = new class490(10, Players.field5351);
      int var6 = 0;
      if (var1 != null) {
         this.field4029 = var1;
         this.field4031 = var2;
            ...
            for(var3 = 0; var3 < var2; ++var3) {
               if (this.field4037[var1][var3] == null) {
                  ...
                  if (var4 != null) {
                     ...
                     if (var4[0] == -1) {
                        var5.method8025(new Buffer(var4));
                     } else {
                        var5.method8036(new Buffer(var4));
                     }

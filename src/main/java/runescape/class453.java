...
public final class class453 {
   ...
   public void method9054() {
      synchronized(field5178) {
         if (class22.field91 < class442.field5140) {
            field5178[++class22.field91 - 1] = this;
         }
   ...
   public void method9072(float var1, float var2, float var3) {
      ...
      class453 var4 = class74.method2414();
   ...
   static final void method9084() {
      int var0 = client.field335.field1254;
      int[] var1 = client.field335.field1243;
      Iterator var2 = client.field333.iterator();

      while(var2.hasNext()) {
         class79 var3 = (class79)var2.next();

         for(int var4 = 0; var4 < var0; ++var4) {
            class69 var5 = (class69)var3.field1169.method8567((long)var1[var4]);
            if (var5 != null) {
               class304.method6831(var3, var5, 1);
            }
         }
      }

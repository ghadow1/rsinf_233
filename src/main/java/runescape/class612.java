...
public class class612 {
   ...
   public void method11905(Buffer var1, byte[] var2) {
      if (var1.array[var1.offset * 1216585693] == 31 && var1.array[var1.offset * 1216585693 + 1] == -117) {
         ...
         try {
            this.field6074.setInput(var1.array, var1.offset * 1216585693 + 10, var1.array.length - (var1.offset * 1216585693 + 8 + 10));

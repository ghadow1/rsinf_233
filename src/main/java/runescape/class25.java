...
public class class25 implements KeyListener, FocusListener {
   ...
   static boolean method399() {
      if ((client.field385 & class582.field5863.vmethod11658()) != 0) {
         class52.field765 = "";
         ...
         return true;
      } else if ((client.field385 & class582.field5851.vmethod11658()) != 0) {
         if ((client.field385 & class582.field5859.vmethod11658()) != 0) {
         ...
         class78.method2677(1);
         return true;
      } else if ((client.field385 & class582.field5859.vmethod11658()) != 0) {

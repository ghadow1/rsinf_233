...
public class class110 extends class544 {
   ...
   void method3405(byte[] var1) {
      ...
      this.field1475 = var2.read32BitArray();
      this.field1487 = var2.read32BitArray();
      this.field1486 = var2.read32BitArray();
      this.field1478 = var2.read32BitArray();
      if (this.field1478 < 0) {
         this.field1478 = ~this.field1478;
         this.field1464 = true;
      }

      int var3 = var2.read32BitArray();

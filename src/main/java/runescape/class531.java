...
public class class531 {
   ...
   public static final class531 field5555 = new class531("application/json");
   @ObfuscatedName("aw")
   @ObfuscatedSignature(
      descriptor = "Luj;"
   )
   static final class531 field5554 = new class531("text/plain");
   @ObfuscatedName("at")
   @ObfuscatedSignature(
      descriptor = "Luj;"
   )
   static final class531 field5556 = new class531("application/x-www-form-urlencoded");
   @ObfuscatedName("ac")
   String field5553;

   class531(String var1) {
      this.field5553 = var1;
   }
   ...
   static boolean method10482() {
      ...
      if (var0 == null) {
         ...
         boolean var7 = class223.method4925(var0);
         boolean var8 = class128.method3580(var0);
         if (!var8) {
            class51.method1893("Date not valid.", "Please ensure date follows the format", "DD/MM/YYYY and is after 01/01/1900");
            return false;
         } else {

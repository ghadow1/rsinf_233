...
public class class98 {
   ...
   final void method3101(Buffer var1) {
      this.field1360 = var1.method11196();
      this.field1366 = var1.read32BitArray();
      this.field1365 = var1.read32BitArray();
   ...
   final void method3102(Buffer var1) {
      ...
      for(int var2 = 0; var2 < this.field1367; ++var2) {
         this.field1362[var2] = var1.readUnsignedShort();
         this.field1359[var2] = var1.readUnsignedShort();
      }

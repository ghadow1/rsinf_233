            ...
            try {
                  ...
                  while(true) {
                     ...
                     if (var29 < 100) {
                        if (var29 == 0) {
                           ...
                           class46.field659[++class124.field1569 - 1] = class516.varcs.method2916(var7[var5]);
                        } else if (var29 == 43) {
                           class516.varcs.method2881(var7[var5], class46.field659[--class124.field1569]);
                        } else if (var29 == 44) {
                           var12 = var7[var5] >> 16;
                           var13 = var7[var5] & '\uffff';
                           ...
                           if (var29 == 45) {
                              ...
                              String var34 = class516.varcs.method2884(var7[var5]);
                              class46.field660[++class46.field658 - 1] = var34;
                           } else if (var29 == 50) {
                              class516.varcs.method2883(var7[var5], (String)class46.field660[--class46.field658]);
                           } else if (var29 == 60) {
               ...
               if (var26) {
                  ...
                  if (!var9 && var3 > 0 && class46.field653 >= var3) {
                     class508.RunException_sendStackTrace("Warning: Script " + var1.field795 + " finished at op count " + class46.field653 + " of max " + var2, (Throwable)null);
                  }

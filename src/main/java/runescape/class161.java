...
public class class161 extends class151 {
   ...
   void vmethod4111(Buffer var1) {
      this.field1839 = var1.read32BitArray();
      this.field1838 = var1.method11207();
   }
   ...
   static final void method3908(String var0) {
      class329 var1 = EnumComposition.getPacketBufferNode(ClientPackets.field3617, client.packetWriter.isaacCipher);
      var1.out.writeByte(class288.method6418(var0));
      var1.out.writeNullTermString(var0);
   ...
   public static class436 method3912() {
      return client.field434;
   }
}

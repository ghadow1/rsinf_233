...
public class class413 {
   ...
   public int crcMissmatch = 0;
   @ObfuscatedName("as")
   @ObfuscatedGetter(
      intValue = 1242064413
   )
   public int ioException = 0;
   @ObfuscatedName("al")
   @ObfuscatedSignature(
      descriptor = "Ltf;"
   )
         ...
         try {
            if (this.field5001 > 30000) {
               ...
               while(this.field5005 < 200 && this.field4992 > 0) {
                  ...
                  this.field4988.vmethod10197(var5.array, 0, 4);
               ...
               for(int var16 = 0; var16 < 100; ++var16) {
                  ...
                  if (var6 > 0) {
                     ...
                     if (this.field4995 == null) {
                        ...
                        int var11 = this.field5002.read32BitArray();
                     ...
                     if (var7 == this.field5003.offset * 1216585693) {
                        if (16711935L == this.field4995.field5600) {
                           ...
                           this.crcMissmatch = 0;
                           this.ioException = 0;
                           this.field4995.field4958.method8293((int)(this.field4995.field5600 & 65535L), this.field5003.array, (this.field4995.field5600 & 16711680L) == 16711680L, this.field5000);
                        }
   ...
   public void method8436(boolean var1) {
      if (this.field4988 != null) {
         try {
            ...
            var2.writeTriByte(0);
            this.field4988.vmethod10197(var2.array, 0, 4);
               ...
               if (var3 == null) {
                  if (this.field4987 != 0) {
                     try {
                        ...
                        this.field4988.vmethod10197(var8.array, 0, 4);
   ...
   void method8439(class409 var1, int var2) {
      ...
      if (var3 <= this.field5006.array.length - 8) {
         ...
         var4 = this.field5006.read32BitArray();
         var5 = this.field5006.read32BitArray();
      }
   ...
   int method8442(int var1, int var2) {
      long var3 = (long)((var1 << 16) + var2);
      return this.field4995 != null && this.field4995.field5600 == var3 ? this.field5003.offset * 182899319 / (this.field5003.array.length - this.field4995.field4955) + 1 : 0;
   }

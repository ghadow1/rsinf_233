...
public class class306 implements class309 {
   ...
   public void vmethod6901(Buffer var1) {
      ...
      synchronized(class482.field5317) {
         if (var0.length == 100 && class482.field5329 < class482.field5322) {
            ...
            if (class67.ByteArrayPool_arrays != null) {
               for(int var2 = 0; var2 < class482.ByteArrayPool_alternativeSizes.length; ++var2) {
                  if (var0.length == class482.ByteArrayPool_alternativeSizes[var2] && class476.ByteArrayPool_altSizeArrayCounts[var2] < class67.ByteArrayPool_arrays[var2].length) {
                     class67.ByteArrayPool_arrays[var2][class476.ByteArrayPool_altSizeArrayCounts[var2]++] = var0;
                     return;
                  }
               }
            }
   ...
   static void method6862(int var0, String var1) {
      ...
      boolean var4 = false;
      class613 var5 = new class613(var1, class92.loginType);
      ...
      if (var6 == null) {
         ...
         for(int var7 = 0; var7 < var2; ++var7) {
            ...
            if (var8 != null && var8 != class76.field1108 && var8.field934 != null && var8.field934.equals(var5)) {
               class329 var9;
               if (var0 == 1) {
                  var9 = EnumComposition.getPacketBufferNode(ClientPackets.field3590, client.packetWriter.isaacCipher);
                  var9.out.writeIntME(var3[var7]);
                  var9.out.method11228(0);
                  client.packetWriter.addNode(var9);
               } else if (var0 == 4) {
                  var9 = EnumComposition.getPacketBufferNode(ClientPackets.field3614, client.packetWriter.isaacCipher);
                  var9.out.writeShortBigEndian(var3[var7]);
                  var9.out.writeByte(0);
                  client.packetWriter.addNode(var9);
               } else if (var0 == 6) {
                  var9 = EnumComposition.getPacketBufferNode(ClientPackets.field3558, client.packetWriter.isaacCipher);
                  var9.out.method11325(var3[var7]);
                  var9.out.writeByte(0);
                  client.packetWriter.addNode(var9);
               } else if (var0 == 7) {
                  var9 = EnumComposition.getPacketBufferNode(ClientPackets.field3556, client.packetWriter.isaacCipher);
                  var9.out.writeShortBigEndian(var3[var7]);
                  var9.out.writeMedium(0);
                  client.packetWriter.addNode(var9);
               }

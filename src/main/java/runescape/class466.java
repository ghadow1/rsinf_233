   ...
   int method9520() {
      if (this.method9533()) {
         ...
         if (var1.field5242 == '\n') {
            ...
            return this.field5268.field5228.field5245[42];
         } else {
            int var2 = this.field5268.field5228.field5245[var1.field5242];
            if (var2 == 0) {
               return var1.field5242 == '\t' ? this.field5268.field5228.field5245[32] * 3 : this.field5268.field5228.field5245[32];
            } else {
               return var2;
            }
         }

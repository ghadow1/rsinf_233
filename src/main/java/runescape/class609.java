...
public class class609 {
   ...
   public void method11848(class462 var1, class461 var2) {
      if (var2 != null) {
         int var3 = var2.field5251;
         ...
         class601.method11550(this.field6048, this.field6037, this.field6048 + this.field6040, this.field6037 + this.field6038);
         ...
         int var18;
         if (!var12.method9533()) {
            int var15 = var2.field5260 + var2.field5257;

            for(var16 = 0; var16 < var12.method9532(); ++var16) {
               class464 var23 = var12.method9525(var16);
               var18 = var7 + var23.field5241;
               int var19 = var2.method9414(var23.field5242);
               int var20 = var8 + var23.field5244 - var3;
               class601.method11558(var18, var20, var19, var15, this.field6050);
            }
         }
         ...
         if (this.field6046) {
            ...
            var18 = var17 - var4;
            class601.method11563(var16, var17, var16, var18, this.field6041);
            if (this.field6039 != -1) {
               class601.method11563(var16 + 1, var17 + 1, var16 + 1, var18 + 1, this.field6039);
            }
         }

...
public class class190 extends class540 {
   ...
   void method4288(Buffer var1, int var2) {
      if (var2 == 1) {
         ...
         this.field2071 = var1.read32BitArray();
      } else {
         int var3;
         if (var2 == 5) {
            ...
            for(var3 = 0; var3 < this.field2075; ++var3) {
               this.field2072[var3] = var1.read32BitArray();
            ...
            for(var3 = 0; var3 < this.field2075; ++var3) {
               this.field2072[var3] = var1.read32BitArray();
               this.field2073[var3] = var1.read32BitArray();
            }
         }
      }
   ...
   static final int method4305() {
      float var0 = 200.0F * ((float)class36.clientPreferences.method2566() - 0.5F);

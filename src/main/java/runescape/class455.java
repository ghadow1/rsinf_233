...
public class class455 {
   ...
   static void method9187(int var0, int var1, int var2, int var3) {
      class329 var4 = EnumComposition.getPacketBufferNode(ClientPackets.field3550, client.packetWriter.isaacCipher);
      var4.out.writeByte(18);
      var4.out.writeByte(client.field551.method6138(82) ? (client.field551.method6138(81) ? 2 : 1) : 0);
      var4.out.method11238(var0 + class333.field3836.field1164);
      var4.out.method11238(var1 + class333.field3836.field1165);
      var4.out.writeByte(var2);
      var4.out.writeByte(var3);
      var4.out.writeShortBigEndian(client.field424);
      var4.out.writeByte(57);
      var4.out.writeByte(0);
      var4.out.writeByte(0);
      var4.out.writeByte(89);
      var4.out.writeShortBigEndian(class76.field1108.field1055);
      var4.out.writeShortBigEndian(class76.field1108.field1056);
      var4.out.writeByte(63);

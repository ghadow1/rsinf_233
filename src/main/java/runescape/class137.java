...
public class class137 implements Callable {
   ...
   static class55 method3668(byte[] var0) {
      ...
      int var5 = var2.read32BitArray();
      var1.field799 = var2.readUnsignedShort();
      var1.field797 = var2.readUnsignedShort();
      var1.field802 = var2.readUnsignedShort();
      var1.field804 = var2.readUnsignedShort();
      ...
      if (var6 > 0) {
         ...
         for(var7 = 0; var7 < var6; ++var7) {
            ...
            while(var8-- > 0) {
               int var10 = var2.read32BitArray();
               int var11 = var2.read32BitArray();
      ...
      for(var7 = 0; var2.offset * 1216585693 < var4; var1.field796[var7++] = var8) {
         var8 = var2.readUnsignedShort();
         switch(var8) {
         case 3:
         ...
         default:
            if (var8 <= 99) {
               var1.field801[var7] = var2.read32BitArray();
            } else {
               var1.field801[var7] = var2.method11196();
            }
         }
   ...
   static void method3665() {
      ...
      if (class52.local_username.isEmpty()) {
         ...
         System.out.println(" Wrong something logging out setting state 20 -9993493943");

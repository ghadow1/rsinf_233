   ...
   static void method10970(ArrayList var0, int var1, int var2, int var3, int var4) {
      if (!var0.isEmpty()) {
         ...
         if (var5 == -1 && !client.field446) {
            ...
            if (!var6 && class36.clientPreferences.method2568() != 0) {
               ArrayList var9 = new ArrayList();

               for(int var8 = 0; var8 < var0.size(); ++var8) {
                  var9.add(new class351(class358.field4042, (Integer)var0.get(var8), 0, class36.clientPreferences.method2568(), false));
               }

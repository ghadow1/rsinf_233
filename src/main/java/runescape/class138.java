...
public class class138 {
   ...
   int method3670(Buffer var1, int var2) {
      ...
      class43.method790(var1.method11196());
      ...
      this.field1660 = var9;
      this.field1680 = var1.method11196() != 0;
      this.field1673 = new UserComparator5[var3];
      UserComparator5 var13 = null;

      for(int var12 = 0; var12 < var3; ++var12) {
         UserComparator5 var10 = new UserComparator5();
   ...
   void method3671() {
      ...
      for(int var1 = this.method3673(); var1 <= this.method3682(); ++var1) {
         this.field1675[var1 - this.method3673()] = EnumComposition.method3592(this, (float)var1);
      }

      this.field1673 = null;
      this.field1678 = EnumComposition.method3592(this, (float)(this.method3673() - 1));
      this.field1679 = EnumComposition.method3592(this, (float)(this.method3682() + 1));
   }
   ...
   UserComparator5 method3677(float var1) {

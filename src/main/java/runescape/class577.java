...
public class class577 extends class540 {
   ...
   void method11055(Buffer var1, int var2) {
      if (var2 == 1) {
   ...
   public static class329 method11058(int var0, String var1, class432 var2, int var3) {
      class329 var4 = EnumComposition.getPacketBufferNode(ClientPackets.field3564, client.packetWriter.isaacCipher);
      var4.out.writeByte(0);
      int var5 = var4.out.offset * 1216585693;
      ...
      var4.out.writeByte(var7);
      var4.out.writeByte(var9);
      if (var8 != null) {
         for(int var10 = 0; var10 < var8.length; ++var10) {
            var4.out.writeByte(var8[var10]);
         }
      }

      class359.method7497(var4.out, var1);
      if (var0 == class377.field4336.vmethod11658()) {
         var4.out.writeByte(var3);
      }

      var4.out.method11191(var4.out.offset * 1216585693 - var5);
      return var4;
   }
}

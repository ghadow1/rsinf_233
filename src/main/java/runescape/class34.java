...
public abstract class class34 extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   public static class602 rasterProvider;
   @ObfuscatedName("al")
   ...
   final void method638() {
      ...
      if (var1 != null) {
         ...
         rasterProvider = new class32(screenWidth, class396.screenHeight, this.field208, this.field206);
   ...
   final synchronized void method522() {
      ...
      this.field209 = true;
      if (rasterProvider != null && screenWidth == rasterProvider.field5997 && class396.screenHeight == rasterProvider.field5998) {
         ((class32) rasterProvider).method483(this.field208);
   ...
   protected abstract void isRunning();
         ...
         if (class258.field3092 != null) {
            ...
            if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
               ...
               if (var2.startsWith("1.6.0_")) {
                  ...
                  if (FriendSystem.method1590(var4) && class190.method4308(var4) < 10) {
                     this.method542("wrongjava");
                     return;
                  }
               }
   ...
   static void method684(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if (class36.clientPreferences.method2673() != 0 && var6 > 0 && class58.field836 < 50) {
            ...
            if (var0 == 6506) {
               ...
               if (var0 == 6512) {
                  ...
                  if (var0 == 6513) {
                     ...
                     class46.field659[++class124.field1569 - 1] = client.clientType;
                     return 1;
                  } else if (var0 == 6520) {
                     return 1;
                  } else if (var0 == 6521) {

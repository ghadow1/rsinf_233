...
public class class201 extends class540 {
   ...
   void method4406(Buffer var1, int var2) {
      if (var2 == 1) {
         ...
         this.field2198 = var1.readUnsignedShort();
      } else if (var2 == 4) {
         this.field2193 = var1.readUnsignedShort();
      } else if (var2 == 5) {
         this.field2204 = var1.readUnsignedShort();
      } else if (var2 == 6) {
         ...
         if (var2 == 40) {
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.field2199[var4] = (short)var1.readUnsignedShort();
               this.field2200[var4] = (short)var1.readUnsignedShort();
            }
         } else if (var2 == 41) {
            var3 = var1.method11196();
            ...
            for(var4 = 0; var4 < var3; ++var4) {
               this.field2201[var4] = (short)var1.readUnsignedShort();
               this.field2202[var4] = (short)var1.readUnsignedShort();
            }
         }
      }

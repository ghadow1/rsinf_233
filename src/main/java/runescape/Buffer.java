...
@ObfuscatedName("wb")
public class Buffer extends class544 {
   @ObfuscatedName("au")
   ...
   void vmethod11176() {
      if (this.array != null) {
         class306.method6841(this.array);
      }
   ...
   void method11175(int var1, boolean var2) {
      this.vmethod11176();
      this.array = class403.method8271(var1, var2);
      this.offset = 0;
   }
   ...
   //..writes a 32-bit integer (int var1) into a byte array
   ...
   public void writeNullTermString(String var1) {
      ...
      if (var2 >= 0) {
         ...
         this.offset += class273.method6112(var1, 0, var1.length(), this.array, 1216585693 * this.offset) * -290410379;
   ...
   public void writeString2Array(String var1) {
      int var2 = var1.indexOf(0);
      if (var2 >= 0) {
         throw new IllegalArgumentException("");
      } else {
         this.array[(this.offset += -290410379) * 1216585693 - 1] = 0;
         this.offset += class273.method6112(var1, 0, var1.length(), this.array, this.offset * 1216585693) * -290410379;
         this.array[(this.offset += -290410379) * 1216585693 - 1] = 0;
      }
   }
   ...
   public void method11188(Buffer var1) {
      this.copyArray(var1.array, 0, var1.offset * 1216585693);
   }
   ...
   //..writing a 16-bit (2-byte) unsigned short integer into a byte array in big-endian
   ...
   //.. reads a 32-bit (4-byte) integer value from a byte array
   public int read32BitArray() {
   ...
   public float method11362() {
      return Float.intBitsToFloat(this.read32BitArray());
   }
   ...
   public String method11207() {
      ...
      return var2 == 0 ? "" : class214.method4757(this.array, var1, var2);
   }
   ...
   public String method11361() {
      ...
      if (var1 != 0) {
         ...
         return var3 == 0 ? "" : class214.method4757(this.array, var2, var3);
      }
   }
   ...
   public int method11211() {
      ...
      return var1 < 128 ? this.method11196() - 64 : this.readUnsignedShort() - '쀀';
   }
   ...
   public int method11212() {
      int var1 = this.array[this.offset * 1216585693] & 255;
      return var1 < 128 ? this.method11196() : this.readUnsignedShort() - '耀';
   }
   ...
   public int method11213() {
      int var1 = this.array[this.offset * 1216585693] & 255;
      return var1 < 128 ? this.method11196() - 1 : this.readUnsignedShort() - '老';
   }
   ...
   public int method11215() {
      return this.array[this.offset * 1216585693] < 0 ? this.read32BitArray() & Integer.MAX_VALUE : this.readUnsignedShort();
   }
   ...
   public int method11222() {
      if (this.array[this.offset * 1216585693] < 0) {
         return this.read32BitArray() & Integer.MAX_VALUE;
      } else {
   ...
   public void method11220(int[] var1) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         int var4 = this.read32BitArray();
         int var5 = this.read32BitArray();
         int var6 = 0;
         int var7 = -1640531527;
   ...
   public void xteaEncrytion(int[] var1, int var2, int var3) {
      int var4 = this.offset * 1216585693;
      this.offset = var2 * -290410379;
      int var5 = (var3 - var2) / 8;

      for(int var6 = 0; var6 < var5; ++var6) {
         int var7 = this.read32BitArray();
         int var8 = this.read32BitArray();
         int var9 = 0;
   ...
   //..2-bit integer var1 into a byte array this.array in little-endian order

...
class class141 implements Callable {
   ...
   public static class454 method3729(class454 var0) {
      synchronized(class454.field5185) {
         if (class172.field1931 == 0) {
            return new class454(var0);
         } else {
            class454.field5185[--class172.field1931].method9092(var0);
   ...
   public static int method3728(CharSequence var0) {
      int var1 = var0.length();
      int var2 = 0;

      for(int var3 = 0; var3 < var1; ++var3) {
         var2 = (var2 << 5) - var2 + class121.method3526(var0.charAt(var3));
      }

...
public final class class382 {
   ...
   public static Object method8182(byte[] var0, boolean var1) {
      if (var0 == null) {
         ...
         class373 var2 = new class373();
         var2.vmethod8137(var0);
         return var2;
      } else {
         return var0;
      }
   ...
   static class519 method8181(int var0, Object var1) {
      class519 var2 = (class519)var1;
      if (var2 == null) {
   ...
   static final void method8179(int var0, int var1, int var2, boolean var3) {
      if (class119.field1554.method7478(var0)) {
         class537.method10545(class119.field1554.field4037[var0], 0, class119.field1554.field4037[var0].length - 1, -1, -1, var1, var2, var3);
      }
   }
}

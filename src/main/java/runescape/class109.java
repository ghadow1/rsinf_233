...
public class class109 {
   ...
   void method3395(Buffer var1) {
      this.field1446 = var1.read32BitArray();
      this.field1447 = var1.read32BitArray();
      this.field1448 = var1.read32BitArray();
      this.field1454 = var1.read32BitArray();
      if (this.field1454 < 0) {
         this.field1454 = ~this.field1454;
         this.field1450 = true;
      }

      int var2 = var1.read32BitArray();

...
public final class class291 {
   ...
   public void method6638(class412 var1, String var2, boolean var3) {
      if (!this.field3370) {
         ...
         Buffer var6 = new Buffer(var1.method8371(class308.field3498.field3496, var2));
         Buffer var7 = new Buffer(var1.method8371(class308.field3494.field3496, var2));
         System.nanoTime();
         System.nanoTime();
      ...
      if (this.field3364 != null) {
         ...
         if (var6 > 0 && var6 % var7 < var7 / 2) {
            ...
            while(true) {
               ...
               while(var11.hasNext()) {
                  Occluder var12 = (Occluder)var11.next();

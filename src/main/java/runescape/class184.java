      ...
      if (var2 == 1) {
         ...
         if (var2 == 7) {
            ...
            for(var5 = 0; var5 < this.field2009.length; ++var5) {
               this.field2009[var5] = var1.read32BitArray();
            }
            ...
            if (var2 == 17) {
               ...
               this.field2011 = (class193)class173.findEnumerated(var3, var1.method11196());
            } else if (var2 == 30) {
               class198[] var7 = new class198[]{class198.field2167, class198.field2172, class198.field2169};
               this.field1999 = (class198)class173.findEnumerated(var7, var1.method11196());
            }
         }
      }

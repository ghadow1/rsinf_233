...
public class class124 extends class500 {
   ...
   static final void method3545(class79 var0, byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      ...
      class590 var25 = new class590(var1);
      ...
      var13 = var25.buffer * 1216585693 < var25.index.length ? var25.method11196() : 0;
   ...
   static final void method3552(boolean var0, class589 var1) {
      ...
      if (!client.field473) {
         ...
         int var4 = var1.method11198();
         class267.field3170 = new int[var4][4];

         for(var5 = 0; var5 < var4; ++var5) {
            for(var6 = 0; var6 < 4; ++var6) {
               class267.field3170[var5][var6] = var1.method11202();
            }
         }
         ...
         for(var6 = 0; var6 < var5; ++var6) {
            for(var7 = 0; var7 < 4; ++var7) {
               class267.field3170[var6][var7] = var1.method11202();
            }
         }

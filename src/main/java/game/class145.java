...
final class class145 implements ThreadFactory {
   ...
   static void method3748(class329 var0) {
      System.out.println("--- Starting method3748 writes ---");

      int crcBlockValue = class193.field2091.field4959;
      var0.field3664.writeIntBigEndian(crcBlockValue); // crcBlock
      System.out.printf("Writing intBigEndian: %d (0x%08X)\n", crcBlockValue, crcBlockValue);

      int value234 = class496.field5387.field4959;
      var0.field3664.putIntCustomEndian234(value234);
      System.out.printf("Writing putIntCustomEndian234: %d (0x%08X)\n", value234, value234);

      int valueLittle1 = field1726.field4959;
      var0.field3664.putIntLittleEndian(valueLittle1);
      System.out.printf("Writing putIntLittleEndian: %d (0x%08X)\n", valueLittle1, valueLittle1);

      int valueLittle2 = class358.field4042.field4959;
      var0.field3664.putIntLittleEndian(valueLittle2);
      System.out.printf("Writing putIntLittleEndian: %d (0x%08X)\n", valueLittle2, valueLittle2);

      int valueLittle3 = class159.field1830.field4959;
      var0.field3664.putIntLittleEndian(valueLittle3);
      System.out.printf("Writing putIntLittleEndian: %d (0x%08X)\n", valueLittle3, valueLittle3);

      int value234_2 = class115.field1514.field4959;
      var0.field3664.putIntCustomEndian234(value234_2);
      System.out.printf("Writing putIntCustomEndian234: %d (0x%08X)\n", value234_2, value234_2);

      int valueCustom = class27.field130.field4959;
      var0.field3664.putIntCustomEndian(valueCustom);
      System.out.printf("Writing putIntCustomEndian: %d (0x%08X)\n", valueCustom, valueCustom);

      System.out.println("--- Finished method3748 writes ---");
   }

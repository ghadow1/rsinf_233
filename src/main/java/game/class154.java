...
public class class154 {
   ...
   void method3837(class590 var1) {
      this.field1793 = var1.method11203();
      this.field1787 = var1.method11202();
   ...
   static final void method3846(String var0) {
      if (var0.equalsIgnoreCase("toggleroof")) {
         class36.field239.method2556(!class36.field239.method2672());
      ...
      if (var0.startsWith("setdrawdistance")) {
         ...
         try {
            ...
            class36.field239.method2555(var2);
      ...
      if (var0.equalsIgnoreCase("getdrawdistance")) {
         class90.method2893(99, "", String.format("%d", class36.field239.method2585()));
      }
      ...
      if (client.field428 >= 2) {
         ...
         if (var0.equalsIgnoreCase("fpson")) {
            class36.field239.method2563(true);
         }

         if (var0.equalsIgnoreCase("fpsoff")) {
            class36.field239.method2563(false);
         }
         ...
         if (var0.equalsIgnoreCase("clientreload")) {
            ...
            class36.field239.method2668(true);
         } else if (var0.equalsIgnoreCase("sfx16bit")) {
            class36.field239.method2668(false);
            ...
            try {
               if (class36.field239.method2568() == 0) {
                  ...
                  var2 = class36.field239.method2568();
                  class257.method5884(0, 0);
      ...
      class329 var10 = class130.method3593(class327.field3635, client.field314.field1308);
      var10.field3664.writeByte(var0.length() + 1);
      var10.field3664.writeNullTermString(var0);
      client.field314.prepData(var10);
   }
}

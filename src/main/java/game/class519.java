...
public class class519 {
   ...
   public class519(class574 var1, boolean var2) {
      this.field5504 = var1;
      this.field5501 = var2;
   }
   ...
   public class519(class574 var1, Object var2, int var3, int var4) {
      this.field5501 = true;
      this.field5504 = var1;
      this.field5503 = var4;
      this.field5500 = var2;
      if (var1 == class574.field5820) {
         this.field5505 = new int[var4];
   ...
   public final int method10322() {
      return this.field5502 * -1549457881;
   }
   ...
   final void method10363(int var1, Object var2) {
      if (this.field5504 == class574.field5820) {
         this.field5505[var1] = (Integer)var2;
   ...
   void method10328(int var1) {
      if (this.field5503 != var1) {
         this.field5503 = var1;
         if (this.field5504 == class574.field5820) {
            this.field5505 = Arrays.copyOf(this.field5505, var1);
         } else if (this.field5504 == class574.field5816) {
   ...
   final void method10362(int var1) {
      int var2 = this.field5502 * -1549457881;
      this.field5502 = var1 * -698619497;
      if (var1 < var2) {
         if (this.field5504 == class574.field5820) {
            Arrays.fill(this.field5505, var1, var2, 0);
         } else if (this.field5504 == class574.field5816) {
         ...
         if (this.field5504 == class574.field5820) {
            ...
            if (var5 != 0) {
               Arrays.fill(this.field5505, var2, var1, var5);
            }
         } else if (this.field5504 == class574.field5816) {
   ...
   public void method10329(class590 var1) {
      var1.writeShortBigEndian(this.field5502 * -1549457881);
      int var2;
      if (this.field5504 == class574.field5820) {
         var1.writeByte(0);

         for(var2 = 0; var2 < this.field5502 * -1549457881; ++var2) {
            var1.writeIntBigEndian(this.field5505[var2]);
         }
      } else if (this.field5504 == class574.field5816) {
         var1.writeByte(1);
         ...
         for(var2 = 0; var2 < this.field5502 * -1549457881; ++var2) {
            var1.writeNullTermString((String)this.field5506[var2]);
         }
      }

...
public class class146 extends class540 {
   ...
   void method3783(class590 var1, int var2) {
      var1.method11198();
      var1.method11198();
      ...
      for(var5 = 0; var5 < var3; ++var5) {
         ...
         class139 var16 = (class139)class173.method4100(class389.method8215(), var7);
         if (var16 == null) {
         ...
         class140 var12 = (class140)class173.method4100(class297.method6781(), var11);
         if (var12 == null) {
   ...
   static int method3752(int var0, class55 var1, boolean var2) {
      if (var0 == 5000) {
         ...
         class329 var13 = class130.method3593(class327.field3584, client.field314.field1308);
         var13.field3664.writeByte(client.field444);
         var13.field3664.writeByte(class184.field2013.field6073);
         var13.field3664.writeByte(client.field440);
         ...
         if (var0 == 5002) {
            ...
            var6 = class130.method3593(class327.field3594, client.field314.field1308);
            var6.field3664.writeByte(class288.method6418(var8) + 2);
            var6.field3664.writeNullTermString(var8);
            var6.field3664.writeByte(var7 - 1);
            var6.field3664.writeByte(var9);
            ...
            if (var0 == 5003) {
               ...
               if (var0 == 5004) {
                  ...
                  if (var0 == 5008) {
                     ...
                     client.field314.prepData(var12);
                     return 1;
                  } else if (var0 == 5009) {
                     class46.field658 -= 2;
                     var8 = (String)class46.field660[class46.field658];
                     String var11 = (String)class46.field660[class46.field658 + 1];
                     var12 = class130.method3593(class327.field3605, client.field314.field1308);
                     var12.field3664.writeShortBigEndian(0);
                     int var10 = var12.field3664.buffer * 1216585693;
                     var12.field3664.writeNullTermString(var8);
                     class359.method7497(var12.field3664, var11);
                     var12.field3664.putUnsignedShortBigEndian(var12.field3664.buffer * 1216585693 - var10);
                     client.field314.prepData(var12);
                     return 1;
                  } else if (var0 == 5010) {
                     var8 = (String)class46.field660[--class46.field658];
            ...
            if (var0.field3196.method7959(var0.field3197, var0.field3199, 0, 0)) {
               ...
               case 1:
                  if (class328.method7044(class373.method8139(var0.field3196))) {
                     ...
                     if (var4 != null) {
                        class329 var2 = class130.method3593(class327.field3620, client.field314.field1308);
                        var2.field3664.putIntCustomEndian(var4[0]);
                        var2.field3664.putIntLittleEndian(var4[2]);
                        var2.field3664.putIntCustomEndian234(var4[1]);
                        var2.field3664.method11238(var0.field3196.field4145 * -217986249);
                        var2.field3664.writeIntBigEndian(var0.field3196.field4144);
                        var2.field3664.putIntLittleEndian(var0.field3196.method7964());

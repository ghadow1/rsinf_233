   ...
   static final void method6830(class79 var0, int var1, int var2, int var3, int var4) {
      ...
      for(var10 = 0; var10 < client.field409; ++var10) {
         ...
         if (client.field534 == 0) {
            ...
            if (client.field497[var10] == 6) {
               var17 = client.field412 % 20 < 10 ? 16711680 : 16776960;
            }

            if (client.field497[var10] == 7) {
               var17 = client.field412 % 20 < 10 ? 255 : '\uffff';
            }

            if (client.field497[var10] == 8) {
               var17 = client.field412 % 20 < 10 ? '뀀' : 8454016;
            }
            ...
            if (client.field498[var10] == 1) {
               class333.field3831.method9427(var16, client.field503 + var1, var2 + client.field504, var17, 0, client.field412, client.field586[var10]);
            }

            if (client.field498[var10] == 2) {
               class333.field3831.method9428(var16, client.field503 + var1, var2 + client.field504, var17, 0, client.field412, client.field586[var10]);
            }

            if (client.field498[var10] == 3) {
               class333.field3831.method9463(var16, client.field503 + var1, var2 + client.field504, var17, 0, client.field412, 150 - client.field500[var10], client.field586[var10]);
            }

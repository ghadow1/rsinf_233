...
public class class429 {
   ...
   static final class429 field5088 = new class429();
   @ObfuscatedName("aw")
   @ObfuscatedSignature(
      descriptor = "Lqj;"
   )
   static final class429 field5085 = new class429();
   @ObfuscatedName("at")
   @ObfuscatedSignature(
      descriptor = "Lqj;"
   )
   static final class429 field5086 = new class429();
   @ObfuscatedName("ac")
   @ObfuscatedSignature(
      descriptor = "Lqj;"
   )
   static final class429 field5087 = new class429();
   @ObfuscatedName("jj")
   @ObfuscatedSignature(
      descriptor = "Lop;"
   )
   ...
   static boolean method8641(class241 var0, int var1, int var2, int var3, int var4) {
      ...
      if (Math.abs(var12) > var9 + class76.field1113) {
         ...
         return false;
      } else if (Math.abs(var14 * class179.field1965 - var13 * class130.field1591) > var10 * class308.field3500 + var11 * class556.field5750) {
         return false;
      } else if (Math.abs(var12 * class130.field1591 - var14 * class450.field5166) > var11 * class76.field1113 + var9 * class308.field3500) {
         return false;
      } else {

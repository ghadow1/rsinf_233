...
public class class272 implements class29 {
   ...
   class369 field3192 = null;
   @ObfuscatedName("aw")
   boolean field3194 = false;
   @ObfuscatedName("at")
   boolean field3193 = false;
            ...
            if (var2.method423(var1)) {
               ...
               default:
                  if (this.method6090(var1)) {
                     class89.method2877(this.field3192);
                  }
               }
            }
   ...
   public boolean vmethod6117(char var1) {
      if (this.field3192 == null) {
         return false;
      } else if (!class338.method7102(var1)) {
         return false;
      } else {
   ...
   public void method6104(class369 var1) {
      if (var1 != null) {
         ...
         if (var2 != null) {
            if (!var2.field4066.method7839() && var2.field4068 != null) {
               ...
               var3.method2143(var2.field4068);
               class161.method3912().method8689(var3);
            }
   ...
   boolean method6090(int var1) {
      if (this.field3192 == null) {
         ...
         if (var2 != null && var2.method7658()) {
            ...
            case 65:
               if (this.field3194) {
                  var2.method7644(class504.method10061());
               }

               return true;
            case 66:
               if (this.field3194) {
                  var2.method7668(class504.method10061());
               }

               return true;
            case 67:
               if (this.field3194) {
                  var2.method7645(class504.method10061());
               }
            ...
            case 84:
               if (var2.method7783() == 0) {
                  ...
                  var4.method2143(var3.field4070);
                  class161.method3912().method8689(var4);
                  this.method6085();
               }
   ...
   public static void method6110(class519 var0, int var1) {
      ...
      if (var2 > 1) {
         ...
         if (var1 != 0) {
            ...
            if (var0.field5504 == class574.field5820) {
               ...
               class153.method3834(var5, 0, var2 - 1);
               class153.method3834(var5, 0, var1 - 1);
               class153.method3834(var5, var1, var2 - 1);
            }

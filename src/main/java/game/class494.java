...
public class class494 extends class501 {
   ...
   public void method9869(class590 var1, int var2) {
      while(true) {
         if (var1.buffer * 1216585693 < var2) {

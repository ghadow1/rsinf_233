...
public class class265 {
   ...
   public void method5984(boolean var1) {
      this.field3149 = var1;
      this.field3144 = new class14("crmsession", 1, 1);
   }
   ...
   static void method5994(byte[] var0) {
      class590 var1 = new class590(var0);
      var1.buffer = (var0.length - 2) * -290410379;
      class606.field6026 = var1.method11198();
      ...
      var1.buffer = (var0.length - 7 - class606.field6026 * 8) * -290410379;
      class606.field6025 = var1.method11198();
      class581.field5847 = var1.method11198();
      int var2 = (var1.method11196() & 255) + 1;

      int var3;
      for(var3 = 0; var3 < class606.field6026; ++var3) {
         class149.field1763[var3] = var1.method11198();
      }

      for(var3 = 0; var3 < class606.field6026; ++var3) {
         class191.field2082[var3] = var1.method11198();
      }

      for(var3 = 0; var3 < class606.field6026; ++var3) {
         class255.field3068[var3] = var1.method11198();
      }

      for(var3 = 0; var3 < class606.field6026; ++var3) {
         class497.field5390[var3] = var1.method11198();
      }

      var1.buffer = (var0.length - 7 - class606.field6026 * 8 - (var2 - 1) * 3) * -290410379;

...
public class class512 extends class511 {
   ...
   public int vmethod10195() throws IOException {
   ...
   public int vmethod10205() throws IOException {
   ...
   public int vmethod10202(byte[] var1, int var2, int var3) throws IOException {
   ...
   public void copyFlush(byte[] var1, int var2, int var3) throws IOException {

   ...
   static final void method10263(int var0, int var1, boolean var2) {
      if (client.field582[var0] != null) {
         if (var1 >= 0 && var1 < client.field582[var0].method4076()) {
            ...
            class329 var4 = class130.method3593(class327.field3559, client.field314.field1308);
            var4.field3664.writeByte(4 + class288.method6418(var3.field1779.method11909()));
            var4.field3664.writeByte(var0);
            var4.field3664.writeShortBigEndian(var1);
            var4.field3664.method11264(var2);
            var4.field3664.writeNullTermString(var3.field1779.method11909());

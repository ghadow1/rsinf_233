...
public class class162 {
   ...
   void method3982(class590 var1) {
      ...
      if (var2 >= 1 && var2 <= 6) {
         ...
         this.field1870 = var1.method11202();
         this.field1848 = var1.method11202();
         if (var2 <= 3 && this.field1848 != 0) {
            this.field1848 += 16912800;
         }

         this.field1854 = var1.method11198();
         ...
         if (this.field1854 > 0) {
            ...
            for(var4 = 0; var4 < this.field1854; ++var4) {
               ...
               if (var2 >= 2) {
                  this.field1857[var4] = var1.method11202();
               }

               if (var2 >= 5) {
                  this.field1858[var4] = var1.method11198();
               } else {

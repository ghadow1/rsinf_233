...
@ObfuscatedName("ne")
public class class344 extends class544 {
   @ObfuscatedName("aw")
   @ObfuscatedGetter(
      intValue = 1314390951
   )
   ...
   class108[] field3962 = new class108[128];
   @ObfuscatedName("ac")
   short[] field3959 = new short[128];
   @ObfuscatedName("ap")
   byte[] field3956 = new byte[128];
   @ObfuscatedName("aq")
   byte[] field3957 = new byte[128];
   @ObfuscatedName("ao")
   @ObfuscatedSignature(
      descriptor = "[Lnz;"
   )
   class338[] field3963 = new class338[128];
   @ObfuscatedName("as")
   byte[] field3954 = new byte[128];
   @ObfuscatedName("al")
   ArrayList field3960 = new ArrayList(8);
   @ObfuscatedName("au")
   int[] field3961 = new int[128];

   class344(byte[] var1) {
      class590 var2 = new class590(var1);

      int var3;
      for(var3 = 0; var2.index[var3 + var2.buffer * 1216585693] != 0; ++var3) {
      }
      ...
      for(var5 = 0; var5 < var3; ++var5) {
         var4[var5] = var2.method11197();
      }

      var2.buffer += -290410379;
      ++var3;
      var5 = var2.buffer * 1216585693;
      var2.buffer += var3 * -290410379;

      int var6;
      for(var6 = 0; var2.index[var6 + var2.buffer * 1216585693] != 0; ++var6) {
      }
      ...
      for(var8 = 0; var8 < var6; ++var8) {
         var7[var8] = var2.method11197();
      }

      var2.buffer += -290410379;
      ++var6;
      var8 = var2.buffer * 1216585693;
      var2.buffer += -290410379 * var6;

      int var9;
      for(var9 = 0; var2.index[var9 + var2.buffer * 1216585693] != 0; ++var9) {
      }

      byte[] var10 = new byte[var9];

      for(int var11 = 0; var11 < var9; ++var11) {
         var10[var11] = var2.method11197();
      }
      ...
      class338[] var37 = new class338[var12];

      class338 var15;
      for(var14 = 0; var14 < var37.length; ++var14) {
         var15 = var37[var14] = new class338();
         int var40 = var2.method11196();
         if (var40 > 0) {
            var15.field3878 = new byte[var40 * 2];
         }

         var40 = var2.method11196();
         if (var40 > 0) {
      ...
      var14 = var2.method11196();
      byte[] var42 = var14 > 0 ? new byte[var14 * 2] : null;
      var14 = var2.method11196();
      byte[] var16 = var14 > 0 ? new byte[var14 * 2] : null;

      int var17;
      for(var17 = 0; var2.index[var17 + var2.buffer * 1216585693] != 0; ++var17) {
      }
      ...
      this.field3958 = var2.method11196() + 1;
      ...
      for(var27 = 0; var27 < var12; ++var27) {
         ...
         if (var39.field3878 != null) {
            for(var29 = 1; var29 < var39.field3878.length; var29 += 2) {
               var39.field3878[var29] = var2.method11197();
            }
         }

         if (var39.field3879 != null) {
            for(var29 = 3; var29 < var39.field3879.length - 2; var29 += 2) {
               var39.field3879[var29] = var2.method11197();
            }
         }
      }
      ...
      if (var42 != null) {
         for(var27 = 1; var27 < var42.length; var27 += 2) {
            var42[var27] = var2.method11197();
         }
      }

      if (var16 != null) {
         for(var27 = 1; var27 < var16.length; var27 += 2) {
            var16[var27] = var2.method11197();
         }
      }
      ...
      for(var27 = 0; var27 < var12; ++var27) {
         ...
         if (var39.field3879 != null) {
            ...
            for(var29 = 2; var29 < var39.field3879.length; var29 += 2) {
               var19 = 1 + var19 + var2.method11196();
      ...
      for(var27 = 0; var27 < var12; ++var27) {
         ...
         if (var39.field3878 != null) {
            ...
            for(var29 = 2; var29 < var39.field3878.length; var29 += 2) {
               var19 = var19 + 1 + var2.method11196();
      ...
      for(var27 = 0; var27 < var12; ++var27) {
         var37[var27].field3880 = var2.method11196();
      }

      for(var27 = 0; var27 < var12; ++var27) {
         var39 = var37[var27];
         if (var39.field3878 != null) {
            var39.field3881 = var2.method11196();
         }

         if (var39.field3879 != null) {
            var39.field3882 = var2.method11196();
         }

         if (var39.field3880 > 0) {
            var39.field3883 = var2.method11196();
         }
      }

      for(var27 = 0; var27 < var12; ++var27) {
         var37[var27].field3886 = var2.method11196();
      }

      for(var27 = 0; var27 < var12; ++var27) {
         var39 = var37[var27];
         if (var39.field3886 > 0) {
            var39.field3884 = var2.method11196();
         }
      }
      ...
      for(var27 = 0; var27 < var12; ++var27) {
         ...
         if (var39.field3884 > 0) {
            var39.field3885 = var2.method11196();
         }
      }
   ...
   boolean method7328(class100 var1, BitSet var2) {
      boolean var3 = true;
      int var4 = 0;
   ...
   static final void method7331(class79 var0, byte[] var1, int var2, int var3, int var4, int var5) {
      int var8;
      int var9;
      if (var0.field1175 != null) {
         for(int var6 = 0; var6 < 4; ++var6) {
            class275 var13 = var0.field1175[var6];
      ...
      class590 var12 = new class590(var1);
      ...
      for(var7 = 0; var7 < 4; ++var7) {
         for(var8 = 0; var8 < 64; ++var8) {
            for(var9 = 0; var9 < 64; ++var9) {
               var10 = var8 + var2;
               int var11 = var3 + var9;
               class144.method3741(var0, var12, var7, var10, var11, var10 + var4, var5 + var11, 0);
            }
         }
      }

      var7 = var12.buffer * 1216585693 < var12.index.length ? var12.method11196() : 0;
      boolean var14 = (var7 & 1) != 0;
      if (var14) {
         for(var9 = 0; var9 < 64; ++var9) {
            for(var10 = 0; var10 < 64; ++var10) {
               class190.method4307(var12);
            }
         }
      }

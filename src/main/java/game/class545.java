...
@ObfuscatedName("uv")
public class class545 implements class547 {
   @ObfuscatedName("lc")
   @ObfuscatedGetter(
      intValue = -1637282951
   )
   static int field5606;
   @ObfuscatedName("ac")
   @ObfuscatedGetter(
      intValue = 853356597
   )
   ...
   public class546 vmethod10587() {
      byte var1;
      if (class260.field3106.startsWith("win")) {
         var1 = 1;
      } else if (class260.field3106.startsWith("mac")) {
         var1 = 2;
      } else if (class260.field3106.startsWith("linux")) {
         var1 = 3;
      } else {
         var1 = 4;
      }
      ...
      String var28 = "";
      boolean var29 = false;
      return new class546(var1, var30, var8, var9, this.field5602, this.field5604, this.field5605, false, var11, var12, var13, 0, var14, var15, var16, var17, 0, 0, 0, 0, var18, var19, var24, 0, "", "", var28);
   }

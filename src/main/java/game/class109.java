...
public class class109 {
   ...
   void method3395(class590 var1) {
      this.field1446 = var1.method11202();
      this.field1447 = var1.method11202();
      this.field1448 = var1.method11202();
      this.field1454 = var1.method11202();
      if (this.field1454 < 0) {
         this.field1454 = ~this.field1454;
         this.field1450 = true;
      }

      int var2 = var1.method11202();
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ...
         int var5;
         do {
            var5 = var1.method11196();
            var4 += var5;
         } while(var5 >= 255);

         byte[] var6 = new byte[var4];
         var1.method11266(var6, 0, var4);
      ...
      for(int var3 = 0; var3 < this.field1445.length; ++var3) {
         ...
         if (var4 != null) {
            ...
            for(int var6 = 0; var6 < var5; ++var6) {
               var1[var2++] = (short)class505.method10135(-32768, 32767, (int)(32768.0F * var4[var6]));
            }
         }
      }

      this.field1451 = null;
      return new class95(this.field1446, var1, this.field1448, this.field1454, this.field1450, false);
   }
   ...
   float[] method3393(int var1) {
      ...
      class105 var15 = this.field1436[this.field1428[var3]];
      ...
      for(var20 = 0; var20 < var15.field1417; ++var20) {
         class101 var45 = this.field1433[var15.field1414[var20]];
   ...
   void method3397(byte[] var1, int var2) {
      ...
      this.field1439 = new class107[var4];

      for(var5 = 0; var5 < var4; ++var5) {
         this.field1439[var5] = new class107(var3);
      }
      ...
      var5 = var3.method3467(6) + 1;
      this.field1449 = new class96[var5];

      for(var6 = 0; var6 < var5; ++var6) {
         this.field1449[var6] = new class96(var3);
      }

      var6 = var3.method3467(6) + 1;
      this.field1433 = new class101[var6];

      for(var7 = 0; var7 < var6; ++var7) {
         this.field1433[var7] = new class101(var3);
      }

      var7 = var3.method3467(6) + 1;
      this.field1436 = new class105[var7];

      for(var8 = 0; var8 < var7; ++var8) {
         this.field1436[var8] = new class105(var3);
      }
   ...
   static void method3399(int var0, String var1, String var2, String var3) {
      class57 var4 = (class57)class91.field1286.get(var0);
      if (var4 == null) {
         var4 = new class57();
         class91.field1286.put(var0, var4);
      }

      class39 var5 = var4.method2012(var0, var1, var2, var3);
      class91.field1287.method8590(var5, (long)var5.field267);
      class91.field1283.method8847(var5);
      client.field525 = client.field404;
   }
}

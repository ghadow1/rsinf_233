...
@ObfuscatedName("eo")
public class class110 extends class544 {
   @ObfuscatedName("af")
   @ObfuscatedSignature(
      descriptor = "Led;"
   )
   static class115 field1465 = new class115();
   @ObfuscatedName("aw")
   @ObfuscatedSignature(
      descriptor = "[Leb;"
   )
   static class107[] field1457;
   @ObfuscatedName("at")
   ...
   static class96[] field1460;
   @ObfuscatedName("aq")
   @ObfuscatedSignature(
      descriptor = "[Ldj;"
   )
   static class101[] field1479;
   @ObfuscatedName("ao")
   @ObfuscatedSignature(
      descriptor = "[Lez;"
   )
   static class105[] field1462;
   @ObfuscatedName("as")
   static boolean[] field1463;
   @ObfuscatedName("al")
   static int[] field1477;
   @ObfuscatedName("au")
   static boolean field1461 = false;
   @ObfuscatedName("ai")
   ...
   class110(byte[] var1) {
      this.method3405(var1);
   }

   @ObfuscatedName("ap")
   void method3405(byte[] var1) {
      class590 var2 = new class590(var1);
      this.field1475 = var2.method11202();
      this.field1487 = var2.method11202();
      this.field1486 = var2.method11202();
      this.field1478 = var2.method11202();
      if (this.field1478 < 0) {
         this.field1478 = ~this.field1478;
         this.field1464 = true;
      }

      int var3 = var2.method11202();
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         int var6;
         do {
            var6 = var2.method11196();
            var5 += var6;
         } while(var6 >= 255);

         byte[] var7 = new byte[var5];
         var2.method11266(var7, 0, var5);
   ...
   float[] method3410(int var1) {
      ...
      class105 var15 = field1462[field1477[var3]];
      ...
      for(var20 = 0; var20 < var15.field1417; ++var20) {
         class101 var45 = field1479[var15.field1414[var20]];
   ...
   class95 method3407(int[] var1) {
      if (var1 != null && var1[0] <= 0) {
         ...
         if (this.field1485 == null) {
            ...
            this.field1485 = new short[this.field1487];
            this.field1484 = 0;
            this.field1481 = 0;
         }
         ...
         for(; this.field1481 < this.field1474.length; ++this.field1481) {
            ...
            if (var2 != null) {
               ...
               for(int var5 = 0; var5 < var4; ++var5) {
                  this.field1485[var3++] = (short)class505.method10135(-32768, 32767, (int)(var2[var5] * 32768.0F));
               }
         ...
         this.field1480 = null;
         short[] var6 = this.field1485;
         this.field1485 = null;
         return new class95(this.field1475, var6, this.field1486, this.field1478, this.field1464, false);
      }
   }

   @ObfuscatedName("af")
   static float method3401(int var0) {
   ...
   static void method3402(byte[] var0) {
      ...
      field1457 = new class107[var2];

      for(var3 = 0; var3 < var2; ++var3) {
         field1457[var3] = new class107(field1465);
      }
      ...
      var3 = var1.method3467(6) + 1;
      field1460 = new class96[var3];

      for(var4 = 0; var4 < var3; ++var4) {
         field1460[var4] = new class96(field1465);
      }

      var4 = var1.method3467(6) + 1;
      field1479 = new class101[var4];

      for(var5 = 0; var5 < var4; ++var5) {
         field1479[var5] = new class101(field1465);
      }

      var5 = var1.method3467(6) + 1;
      field1462 = new class105[var5];

      for(var6 = 0; var6 < var5; ++var6) {
         field1462[var6] = new class105(field1465);
      }
   ...
   static boolean method3403(class412 var0) {
      if (!field1461) {
         byte[] var1 = var0.method8335(0, 0);
         if (var1 == null) {
            return false;
         }
   ...
   static class110 method3417(class412 var0, int var1, int var2) {
      if (!method3403(var0)) {
         var0.method8337(var1, var2);
         return null;
      } else {

   ...
   static final void method8188(int var0, int var1) {
      if (client.field582[var0] != null) {
         if (var1 >= 0 && var1 < client.field582[var0].method4076()) {
            ...
            if (var2.field1782 == -1) {
               class329 var3 = class130.method3593(class327.field3602, client.field314.field1308);
               var3.field3664.writeByte(3 + class288.method6418(var2.field1779.method11909()));
               var3.field3664.writeByte(var0);
               var3.field3664.writeShortBigEndian(var1);
               var3.field3664.writeNullTermString(var2.field1779.method11909());

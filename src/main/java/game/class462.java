...
public class class462 {
   ...
   int field5227 = Integer.MAX_VALUE;
   @ObfuscatedName("ay")
   @ObfuscatedGetter(
      intValue = 2109695381
   )
   int field5225 = Integer.MAX_VALUE;
   @ObfuscatedName("ad")
   @ObfuscatedGetter(
      intValue = 1977097609
   )
   ...
   class465 field5228;
   @ObfuscatedName("ax")
   ArrayList field5229 = new ArrayList();
   @ObfuscatedName("ak")
   @ObfuscatedGetter(
      intValue = -197294049
   )
   ...
   public void method9353(class465 var1) {
      if (var1 != this.field5228) {
         this.field5228 = var1;
         if (this.field5228 != null) {
            if (this.field5231 == 0) {
               this.field5231 = this.field5228.field5251;
            }
   ...
   public int method9288() {
      return this.method9338() ? 0 : this.field5228.field5251 + ((class464)this.field5229.get(this.field5229.size() - 1)).field5244;
   }
   ...
   public int method9365() {
      return this.method9288() / this.field5228.field5251;
   }
   ...
   public void method9293(int var1) {
      if (this.field5228 != null && var1 < this.field5228.field5251 * 2) {
   ...
   int method9304(class464 var1, boolean var2) {
      if (var1.field5242 == '\n') {
         ...
         int var3 = this.field5228.field5245[var1.field5242];
         if (var3 == 0) {
            return var1.field5242 == '\t' ? this.field5228.field5245[32] * 3 : this.field5228.field5245[32];
         } else {
            return var3;
         }
      } else {
         return this.field5228.field5245[42];
      }
   }

...
public class class366 {
   ...
   class462 field4108 = new class462();
   @ObfuscatedName("ag")
   @ObfuscatedSignature(
      descriptor = "Lrb;"
   )
   class462 field4098 = new class462();
   @ObfuscatedName("av")
   boolean field4099 = false;
   @ObfuscatedName("ah")
   boolean field4100 = true;
   @ObfuscatedName("ab")
   @ObfuscatedGetter(
      intValue = 488555555
   )
   ...
   int field4097 = Integer.MAX_VALUE;
   @ObfuscatedName("ba")
   @ObfuscatedGetter(
      intValue = 526154253
   )
   int field4111 = Integer.MAX_VALUE;
   @ObfuscatedName("bb")
   @ObfuscatedGetter(
      intValue = 1287946861
   )
   ...
   boolean method7746(class465 var1) {
   ...
   boolean method7683(int var1) {
      ...
      case 1:
         return class249.method5776((char)var1);
      case 2:
         return class269.method6055((char)var1);
      case 3:
         return class406.method8275((char)var1);
      case 4:
         char var2 = (char)var1;
         if (class406.method8275(var2)) {
            return true;
         } else {

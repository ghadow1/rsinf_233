...
public class class475 extends class477 {
   ...
   static int method9652(int var0, class55 var1, boolean var2) {
      if (var0 == 5306) {
         class46.field659[++class124.field1569 - 1] = class35.method729();
         return 1;
      } else {
         int var3;
         if (var0 == 5307) {
            ...
            if (var3 == 1 || var3 == 2) {
               class208.method4531(var3);
            }

            return 1;
         } else if (var0 == 5308) {
            class46.field659[++class124.field1569 - 1] = class36.field239.method2574();
            return 1;
         } else if (var0 != 5309) {
            if (var0 == 5310) {
               --class124.field1569;
            ...
            var3 = class46.field659[--class124.field1569];
            if (var3 == 1 || var3 == 2) {
               class36.field239.method2567(var3);
            }
      ...
      if (!var0) {
         ...
         if (!var0) {
            ...
            if (client.field476 != 0) {
               class464.method9402("Loading - please wait." + "<br>" + " (" + 100 + "%" + ")", true);
            }
            ...
            if (class521.field5519.method545()) {
               var19 = class130.method3593(class327.field3606, client.field314.field1308);
               var19.field3664.writeIntBigEndian(1057001181);
               client.field314.prepData(var19);
            }
            ...
            class125.method3557();
            class195.method4383();
            var19 = class130.method3593(class327.field3587, client.field314.field1308);
            client.field314.prepData(var19);
            class144.method3738();

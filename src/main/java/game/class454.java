...
public final class class454 {
   ...
   public static final class454 field5184 = new class454();
   @ObfuscatedName("at")
   @ObfuscatedSignature(
      descriptor = "[Lrj;"
   )
   static class454[] field5185 = new class454[0];
   @ObfuscatedName("ac")
   @ObfuscatedGetter(
      intValue = 886646907
   )
   ...
   public static class412 field5183;
   @ObfuscatedName("aq")
   public float[] field5186 = new float[16];

   static {
      class238.method5424(16);
   }
   ...
   public class454(class590 var1, boolean var2) {
   ...
   public void method9092(class454 var1) {
   ...
   public void method9095(class454 var1) {
   ...
   public void method9173(class454 var1) {
   ...
   public void method9085(float var1, float var2, float var3, float[] var4) {
   ...
   public class452 method9144(float var1, float var2, float var3) {
      ...
      return class296.method6761((var3 * this.field5186[8] + this.field5186[0] * var1 + var2 * this.field5186[4] + this.field5186[12]) * var4, (var1 * this.field5186[1] + var2 * this.field5186[5] + this.field5186[9] * var3 + this.field5186[13]) * var4, var4 * (this.field5186[14] + this.field5186[6] * var2 + var1 * this.field5186[2] + var3 * this.field5186[10]));
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof class454)) {
         return false;
      } else {
         class454 var2 = (class454)var1;
   ...
   public static class579 method9162(int var0) {
      class579 var1 = (class579)class579.field5842.method7018((long)var0);
      if (var1 != null) {
         return var1;
      } else {
         byte[] var2 = class579.field5839.method8335(38, var0);
         var1 = new class579();
         if (var2 != null) {
            var1.method11067(new class590(var2));
         }

         var1.method11070();
         class579.field5842.method7009(var1, (long)var0);
         return var1;
      }
   }

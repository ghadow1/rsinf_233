...
public class class365 {
   ...
   public void method7578(class590 var1) {
   ...
   static void method7601() {
      ...
      if (class516.field5478 != null) {
         class516.field5478.method2885();
      }

      client.field429 = -1;
      if (client.field421 != -1) {
         class119.field1554.method7479(client.field421);
      }
      ...
      if (client.field314 != null && client.field314.field1308 != null) {
         class329 var2 = class130.method3593(class327.field3568, client.field314.field1308);
         var2.field3664.writeByte(class35.method729());
         var2.field3664.writeShortBigEndian(class34.screenWidth);
         var2.field3664.writeShortBigEndian(class396.screenHeight);

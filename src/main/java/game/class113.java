...
public class class113 {
   @ObfuscatedName("ap")
   static float[][] field1493 = new float[2][8];
   @ObfuscatedName("aq")
   static int[][] field1495 = new int[2][8];
   @ObfuscatedName("ao")
   ...
   int method3431(int var1, float var2, int var3) {
      ...
      if (this.field1498[var1] == 0) {
         ...
         float[] var10000;
         int var5;
         for(var5 = 1; var5 < this.field1498[var1]; ++var5) {
         ...
         if (var1 == 0) {
            for(var5 = 0; var5 < this.field1498[0] * 2; ++var5) {
               var10000 = field1493[0];
               var10000[var5] *= field1496;
            }
         }

         for(var5 = 0; var5 < this.field1498[var1] * 2; ++var5) {
            field1495[var1][var5] = (int)(field1493[var1][var5] * 65536.0F);
         }
   ...
   final void method3436(class590 var1, class98 var2) {
      int var3 = var1.method11196();
      this.field1498[0] = var3 >> 4;
      this.field1498[1] = var3 & 15;
      if (var3 != 0) {
         this.field1490[0] = var1.method11198();
         this.field1490[1] = var1.method11198();
         ...
         for(var5 = 0; var5 < 2; ++var5) {
            for(var6 = 0; var6 < this.field1498[var5]; ++var6) {
               this.field1499[var5][0][var6] = var1.method11198();
               this.field1500[var5][0][var6] = var1.method11198();
            }
         }
         ...
         for(var5 = 0; var5 < 2; ++var5) {
            for(var6 = 0; var6 < this.field1498[var5]; ++var6) {
               if ((var7 & 1 << var5 * 4 << var6) != 0) {
                  this.field1499[var5][1][var6] = var1.method11198();
                  this.field1500[var5][1][var6] = var1.method11198();
               } else {
   ...
   @ObfuscatedName("af")
   static float method3432(float var0, int var1) {

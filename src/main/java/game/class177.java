...
public class class177 extends class540 {
   ...
   void method4154(class590 var1, int var2) {
      if (var2 == 2) {
         this.field1961 = var1.method11198();
      }
   ...
   public static class215 method4155(int var0) {
      ...
      if (var1 != null) {
         ...
         byte[] var2 = class133.field1611.method8335(12, var0);
         var1 = new class215();
         if (var2 != null) {
            var1.method4759(new class590(var2));
         }
   ...
   public static class187 method4153(int var0) {
      ...
      if (var1 != null) {
         ...
         var1.field2042 = var0;
         if (var2 != null) {
            var1.method4252(new class590(var2));
         }

...
public abstract class class277 {
               ...
               if (var19 >= 0 && var19 < var1) {
                  ...
                  if (var21 > 0) {
                     ...
                     if (var51 != null) {
                        ...
                        var51 = new class202();
                        if (var52 != null) {
                           var51.method4428(new class590(var52), var23);
                        }
                  ...
                  if (var22 >= 1 && var22 < var2 - 1 && (!client.field565 || (var4[0][var16][var22] & 2) != 0 || (var4[var7][var16][var22] & 16) == 0)) {
                     ...
                     if (var26 > 0 || var27 > 0) {
                        ...
                        if (var26 > 0) {
                           ...
                           var36 = class327.method7039(var38, var39, var40);
                           ...
                           var37 = class327.method7039(var38, var39, var40);
                        }
                        ...
                        if (var27 == 0) {
                           ...
                           if (var42 >= 0) {
                              ...
                              var43 = class327.method7039(var41.field2448, var41.field2449, var41.field2450);
                              ...
                              var44 = class327.method7039(var45, var41.field2449, var46);
                           }
                           ...
                           if (var41.field2453 != -1) {
                              ...
                              var44 = class327.method7039(var46, var41.field2452, var47);
                              var45 = class225.field2639[class312.method6970(var44, 96)];
                           }
   ...
   public static final void method6236(int var0, int var1, int var2, int var3) {
      for(int var4 = 0; var4 < client.field563; ++var4) {
         if (client.field570[var4] + client.field568[var4] > var0 && client.field568[var4] < var0 + var2 && client.field613[var4] + client.field467[var4] > var1 && client.field467[var4] < var3 + var1) {

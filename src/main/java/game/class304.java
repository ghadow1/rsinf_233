...
public class class304 {
   ...
   static final void method6831(class79 var0, class75 var1, int var2) {
      ...
      int var13;
      int var19;
      if (var1.field1085 >= client.field412) {
         class574.method11034(var1);
      } else {
         int var12;
         if (var1.field1094 >= client.field412) {
            boolean var3 = client.field412 == var1.field1094 || !var1.method2420();
            if (!var3) {
            ...
            if (var3) {
               ...
               var5 = client.field412 - var1.field1085;

...
public abstract class class298 {
   ...
   abstract void vmethod6791(class590 var1);
   ...
   void method6815(class412 var1) {
      if (!this.method6785()) {
         ...
         if (var2 != null) {
            this.vmethod6791(new class590(var2));
            this.field3438 = true;
            this.field3439 = true;
         }
   ...
   void method6787(int var1, int var2, class590 var3) {
   ...
   void method6810(int var1, int var2, class590 var3, int var4) {
      boolean var5 = (var4 & 2) != 0;
      if (var5) {
         this.field3434[0][var1][var2] = (short)var3.method11198();
      }

      this.field3430[0][var1][var2] = (short)var3.method11198();
   }
   ...
   void method6790(int var1, int var2, class590 var3, int var4) {
   ...
   static void method6784() {
      client.field314.method2936();
      client.field314.field1289 = 0;
      client.field314.field1293.buffer = 0;
      client.field314.field1304 = null;
      client.field314.field1295 = null;
      client.field314.field1302 = null;
      client.field314.field1306 = null;
      client.field314.field1294 = 0;
      client.field314.field1297 = 0;
      client.field373 = 0;
      class369.method8102();
      client.field585 = 0;
      client.field581 = 0;
      ...
      if (client.field314 != null && client.field314.field1308 != null) {
         class329 var1 = class130.method3593(class327.field3568, client.field314.field1308);
         var1.field3664.writeByte(class35.method729());
         var1.field3664.writeShortBigEndian(class34.screenWidth);
         var1.field3664.writeShortBigEndian(class396.screenHeight);

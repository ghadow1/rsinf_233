...
public class class556 {
   ...
   public static void method10841(class590 var0, int var1) {
      if (class260.field3104 != null) {
         try {
            class260.field3104.method10916(0L);
            class260.field3104.method10937(var0.index, var1, 24);
   ...
   static int method10849(int var0, class55 var1, boolean var2) {
      ...
      if (var0 == 3100) {
         ...
         if (var0 == 3104) {
            var7 = (String)class46.field660[--class46.field658];
            var15 = 0;
            if (class45.method1590(var7)) {
               var15 = class190.method4308(var7);
            }

            class329 var13 = class130.method3593(class327.field3627, client.field314.field1308);
            var13.field3664.writeIntBigEndian(var15);
            client.field314.prepData(var13);
            return 1;
         } else {
            class329 var11;
            if (var0 == 3105) {
               var7 = (String)class46.field660[--class46.field658];
               var11 = class130.method3593(class327.field3636, client.field314.field1308);
               var11.field3664.writeByte(var7.length() + 1);
               var11.field3664.writeNullTermString(var7);
               client.field314.prepData(var11);
               return 1;
            } else if (var0 == 3106) {
               var7 = (String)class46.field660[--class46.field658];
               var11 = class130.method3593(class327.field3586, client.field314.field1308);
               var11.field3664.writeByte(var7.length() + 1);
               var11.field3664.writeNullTermString(var7);
               client.field314.prepData(var11);
               return 1;
               ...
               if (var0 == 3107) {
                  ...
                  class46.field659[++class124.field1569 - 1] = class36.field239.method2672() ? 1 : 0;
                  return 1;
               } else if (var0 == 3112) {
                  class36.field239.method2556(class46.field659[--class124.field1569] == 1);
                  return 1;
               } else if (var0 == 3113) {
                  var7 = (String)class46.field660[--class46.field658];
                  ...
                  var3 = class46.field659[--class124.field1569];
                  var11 = class130.method3593(class327.field3591, client.field314.field1308);
                  var11.field3664.writeShortBigEndian(var3);
                  client.field314.prepData(var11);
                  return 1;
               } else if (var0 == 3116) {
                  var3 = class46.field659[--class124.field1569];
                  ...
                  if (var4.length() > 500) {
                     ...
                     class329 var6 = class130.method3593(class327.field3612, client.field314.field1308);
                     var6.field3664.writeShortBigEndian(1 + class288.method6418(var4) + class288.method6418(var5));
                     var6.field3664.writeNullTermString(var5);
                     var6.field3664.method11229(var3);
                     var6.field3664.writeNullTermString(var4);
                     client.field314.prepData(var6);
                     return 1;
                  }
               } else if (var0 == 3117) {
                  --class124.field1569;
                  ...
                  client.field499 = class46.field659[--class124.field1569] == 1;
                  return 1;
               } else if (var0 == 3126) {
                  ...
                  if (var0 == 3141) {
                     ...
                     class36.field239.method2558(var10);
                     return 1;
                  } else if (var0 == 3142) {
                     class46.field659[++class124.field1569 - 1] = class36.field239.method2557() ? 1 : 0;
                     return 1;
                  } else if (var0 == 3143) {
                     var10 = class46.field659[--class124.field1569] == 1;
                     client.field331 = var10;
                     if (!var10) {
                        class36.field239.method2588("");
                     }

                     return 1;
                  } else if (var0 == 3144) {
                     class46.field659[++class124.field1569 - 1] = client.field331 ? 1 : 0;
                     return 1;
                  } else if (var0 == 3145) {
                     return 1;
                  } else if (var0 == 3146) {
                     var10 = class46.field659[--class124.field1569] == 1;
                     class36.field239.method2560(!var10);
                     return 1;
                  } else if (var0 == 3147) {
                     class46.field659[++class124.field1569 - 1] = class36.field239.method2559() ? 0 : 1;
                     return 1;
                  } else if (var0 == 3148) {
                     return 1;
                  } else if (var0 == 3149) {
                     ...
                     var3 = class46.field659[--class124.field1569];
                     class36.field239.method2555(var3);
                     return 1;
                  } else if (var0 == 3186) {
                     var3 = class36.field239.method2585();

...
public class class211 {
   ...
   static void method4601(int var0) {
      ...
      if (var0 == -3) {
         ...
         class66.method2147("RuneScape has been updated!", "Please restart your game.client.", "");
         ...
         class66.method2147("Malformed login packet.", "Please try again.", "");
      } else if (var0 == 23) {
   ...
   static final void method4600(class328 var0) {
      class589 var1 = client.field314.field1293;
      int var3;
      int var4;
      int var5;
      int var6;
      ...
      if (class328.field3651 == var0) {
         ...
         var30 = var1.readCustomEndianInt2();
         ...
         if (var27 != 65535) {
            class53 var19 = new class53(var16, var26, var18, var12, var4, var31, var9, var10, var3, var6, var27, var11 + client.field412, var13 + client.field412, var34, var5);
         ...
         var11 = var1.readLittleEndianInt();
         ...
         if (0 <= var4 && var4 < 103 && 0 <= var5 && var5 < 103) {
            ...
            if (var24 != null) {
               ...
               if (var25.field2323) {
                  class327.method7038(var10, var4, var5, var30, var31, var9, var27);
                  var24.field1023 = var27;
                  return;
               }
            }

            boolean var33 = class327.method7038(var10, var4, var5, var30, var31, var9, var27);
            if (var33) {
               return;
            }
         ...
         if (var3 >= 0 && var4 >= 0 && var3 < class484.field5343.field1162 && var4 < class484.field5343.field1163) {
            ...
            class48 var35 = new class48(class484.field5343, var6, var31, var3, var4, class413.method8434(class484.field5343, var3, var4, var31) - var30, var5, client.field412);
            class484.field5343.field1174.method8689(var35);
         }

      } else if (class328.field3646 == var0) {
         var27 = var1.method11422();
         var3 = var1.readCustomEndianInt2();
         ...
         var4 = (var27 & 7) + class163.field1873;
         var5 = var1.method11181();
         var6 = var1.readCustomEndianInt2();
         ...
         var27 = var1.readCustomEndianInt();
         ...
         var30 = var1.readCustomEndianInt();

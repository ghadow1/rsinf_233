...
public class class310 extends class289 {
   ...
   void method6915(class590 var1, class590 var2, int var3, boolean var4) {
      this.method6420(var1, var3);
      int var5 = var2.method11198();
   ...
   void method6918(class590 var1, boolean var2) {
      this.field3504 = new LinkedList();
      int var3 = var1.method11198();

      for(int var4 = 0; var4 < var3; ++var4) {
         int var5 = var1.method11222();
         class356 var6 = new class356(var1.method11202());

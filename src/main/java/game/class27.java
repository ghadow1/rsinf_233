      ...
      while(var19 < 4) {
         ...
         if (class260.field3109.exists()) {
            ...
            try {
               ...
               class590 var12;
               int var13;
               for(var12 = new class590((int)var11.method10905()); var12.buffer * 1216585693 < var12.index.length; var12.buffer += -290410379 * var13) {
                  var13 = var11.method10894(var12.index, var12.buffer * 1216585693, var12.index.length - var12.buffer * 1216585693);
                  if (var13 == -1) {

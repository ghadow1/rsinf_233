...
public class class166 extends class151 {
   ...
   void vmethod4111(class590 var1) {
      ...
      this.field1888 = var1.method11198();
   }
   ...
   public static void method4028(class412 var0, int var1) {
      if (!class339.field3889.isEmpty()) {
         ...
         class271.method6081(var2, class339.field3894, class339.field3896, class339.field3898, class339.field3897, false);
      }
   }
}

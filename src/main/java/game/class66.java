...
public class class66 implements Runnable {
   ...
   @ObfuscatedName("af")
   boolean field909 = true;
   @ObfuscatedName("aw")
   Object field906 = new Object();
   @ObfuscatedName("at")
   @ObfuscatedGetter(
      intValue = 2103704019
   )
   ...
   public void run() {
      for(; this.field909; class164.method4001(50L)) {
         synchronized(this.field906) {
            if (this.field907 < 500) {
               this.field908[this.field907] = class35.field231;
               this.field910[this.field907] = class35.field220;
               this.field912[this.field907] = class35.field232;
               ++this.field907;
            }
         }
      }
   ...
   static int method2152(int var0, class55 var1, boolean var2) {
      ...
      if (var0 == 7500) {
         ...
         if (var6 == null) {
            ...
            var7 = class562.method10882(var5);
         ...
         if (var0 == 7502) {
            ...
            int var21 = class562.method10882(var19);
            ...
            --class124.field1569;
            var3 = class46.field659[class124.field1569];
            class578 var24 = class14.method187(var3);
            if (var24 == null) {
               throw new RuntimeException();
            } else {

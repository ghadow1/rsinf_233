...
public abstract class class528 implements class313 {
   ...
   abstract void vmethod10463(class590 var1, int var2);
   ...
   public void method10462(class590 var1) {
      while(true) {
         ...
         class524 var4 = (class524)class173.method4100(var3, var2);
         if (var4 != null) {
            ...
            case 3:
               class173.method4100(class374.method8145(), var1.method11196());
               break;
            default:

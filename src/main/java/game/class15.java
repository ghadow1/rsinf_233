...
public class class15 extends SSLSocketFactory {
   ...
   static class15 field60;
   @ObfuscatedName("aw")
   SecureRandom field61 = new SecureRandom();
   ...
   SSLSocket method192(String var1, TlsClientProtocol var2) {
   ...
   public Socket createSocket(Socket var1, String var2, int var3, boolean var4) throws IOException {
      ...
      return this.method192(var2, var5);
   }
   ...
   public static class15 method201() {
      if (field60 == null) {
         field60 = new class15();
      }

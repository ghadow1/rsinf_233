...
public class class135 {
   ...
   class454 field1631 = new class454();
   @ObfuscatedName("au")
   @ObfuscatedSignature(
      descriptor = "Lrj;"
   )
   class454 field1634 = new class454();
   @ObfuscatedName("ai")
   @ObfuscatedSignature(
      descriptor = "Lrj;"
   )
   class454 field1635 = new class454();
   @ObfuscatedName("aa")
   float[][] field1638;
   @ObfuscatedName("am")
   float[][] field1637;
   ...
   public class135(int var1, class590 var2, boolean var3) {
      this.field1633 = var2.method11452();
      this.field1626 = new class454[var1];
      this.field1627 = new class454[this.field1626.length];
      this.field1632 = new class454[this.field1626.length];
      this.field1628 = new float[this.field1626.length][3];

      for(int var4 = 0; var4 < this.field1626.length; ++var4) {
         this.field1626[var4] = new class454(var2, var3);
   ...
   void method3621() {
      ...
      class454 var1 = class401.method8245();

      for(int var2 = 0; var2 < this.field1626.length; ++var2) {
         class454 var3 = this.method3623(var2);
   ...
   class454 method3626(int var1) {
      if (this.field1627[var1] == null) {
         this.field1627[var1] = new class454(this.method3623(var1));
         if (this.field1636 != null) {
            this.field1627[var1].method9173(this.field1636.method3626(var1));
         } else {
            this.field1627[var1].method9173(class454.field5184);
         }
      }
   ...
   class454 method3625(int var1) {
      if (this.field1632[var1] == null) {
         this.field1632[var1] = new class454(this.method3626(var1));
   ...
   public class454 method3624(int var1) {
      if (this.field1630) {
   ...
   public static void method3657(class412 var0, class412 var1) {
      class201.field2203 = var0;
      class201.field2192 = var1;
   }
}

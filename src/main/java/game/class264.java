...
public class class264 extends class270 {
   ...
   protected static int method5960() {
      int var0 = 0;
      if (class231.field2787 == null || !class231.field2787.isValid()) {
         try {
      ...
      if (class231.field2787 != null) {
         long var9 = class189.method4284();
         long var3 = class231.field2787.getCollectionTime();
         if (-1L != class34.field194) {
            long var5 = var3 - class34.field194;
            long var7 = var9 - class34.field195;
            if (var7 != 0L) {
               var0 = (int)(var5 * 100L / var7);
            }
         }

         class34.field194 = var3;
         class34.field195 = var9;
      }

...
public class class286 {
   ...
   static final void method6372(boolean var0) {
      class125.method3557();
      ++client.field314.field1298;
      if (client.field314.field1298 >= 50 || var0) {
         client.field314.field1298 = 0;
         if (!client.field470 && client.field314.method2941() != null) {
            class329 var1 = class130.method3593(class327.field3639, client.field314.field1308);
            client.field314.prepData(var1);

            try {
               client.field314.queuePackets();

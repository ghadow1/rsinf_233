...
public class class121 {
   ...
   static void method3521(int var0) {
      if (var0 != client.field327) {
         if (client.field327 == 30) {
         ...
         if (var0 == 20 || var0 == 40 || var0 == 45 || var0 == 50) {
            ...
            client.field351 = 0;
            client.field448 = 0;
            client.field471.method8249(var0);
            if (var0 != 20) {
               class325.method7035(false);
            }
         }

         if (var0 != 20 && var0 != 40 && class10.field50 != null) {
            class10.field50.vmethod10196();
            class10.field50 = null;
         }

         if (client.field327 == 25) {
            client.field476 = 0;
            client.field410 = 0;
            client.field411 = 1;
            client.field329 = 0;
         ...
         if (var0 != 5 && var0 != 10) {
            if (var0 == 20) {
               int var4 = client.field327 == 11 ? 4 : 0;
            ...
            if (client.field357 == 1) {
               ...
               for(var6 = 7; var6 >= 0; --var6) {
                  if (client.field516[var6] != null) {
                     ...
                     boolean var8 = false;
                     int var9 = client.field321[var6] + var7;

   ...
   static void method2132() {
      ...
      if (class52.local_password.isEmpty()) {
         ...
         try {
            ...
            class590 var7 = new class590(new byte[1000]);

            while(true) {
               int var8 = var6.read(var7.index, var7.buffer * 1216585693, 1000 - var7.buffer * 1216585693);
               if (var8 == -1) {
                  var7.buffer = 0;
               ...
               var7.buffer += -290410379 * var8;
               if (var7.buffer * 1216585693 >= 1000) {
                  var1 = 0L;
                  break;
               }
            }
         ...
         if (var1 == 0L) {
            ...
            var0 = class296.method6767(var1, class52.local_password);
         }

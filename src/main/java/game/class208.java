...
public class class208 extends class540 {
   ...
   void method4539(class590 var1, int var2) {
      if (var2 == 1) {
         ...
         this.field2273 = var1.method11202();
      } else if (var2 == 4) {
   ...
   static void method4531(int var0) {
      client.field359 = 0L;
      if (var0 >= 2) {
         client.field431 = true;
      } else {
         client.field431 = false;
      }

      if (class35.method729() == 1) {
         class521.field5519.method591(765, 503);
      } else {
         class521.field5519.method591(7680, 2160);
      }

      if (client.field327 >= 25 && client.field314 != null && client.field314.field1308 != null) {

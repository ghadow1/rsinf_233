...
public class class563 {
   @ObfuscatedName("at")
   static final char[] field5780 = new char[]{' ', ' ', '_', '-', 'à', 'á', 'â', 'ä', 'ã', 'À', 'Á', 'Â', 'Ä', 'Ã', 'è', 'é', 'ê', 'ë', 'È', 'É', 'Ê', 'Ë', 'í', 'î', 'ï', 'Í', 'Î', 'Ï', 'ò', 'ó', 'ô', 'ö', 'õ', 'Ò', 'Ó', 'Ô', 'Ö', 'Õ', 'ù', 'ú', 'û', 'ü', 'Ù', 'Ú', 'Û', 'Ü', 'ç', 'Ç', 'ÿ', 'Ÿ', 'ñ', 'Ñ', 'ß'};
   @ObfuscatedName("ac")
   static final char[] field5782 = new char[]{'[', ']', '#'};
   @ObfuscatedName("bc")
   @ObfuscatedGetter(
      intValue = -1353228377
   )
   ...
   public static class449 method10884(class279 var0, class586 var1) {
      int var2 = var1.field5902;
      int var3 = var1.field5899;
      int var4 = var1.field5900;
      int var5 = var1.field5901;
      int var6 = var0.method6289();
      int var7 = var0.method6276();
      int var8 = var0.method6278();
      int var11 = class536.field5571[var6 & 2047];
      double var9 = (double)var11 / 65536.0D;
      double var13 = class215.method4817(var6);
      ...
      synchronized(class449.field5164) {
         class449 var33;
         if (class449.field5161 == 0) {
            var33 = new class449(var29, var31, var34, var35);
         } else {
            --class449.field5161;
            class449.field5164[class449.field5161].method8942(var29, var31);
            class449.field5164[class449.field5161].method8943(var34, var35);
            var33 = class449.field5164[class449.field5161];
         }

   ...
   public static byte[] method8271(int var0, boolean var1) {
      synchronized(class482.field5317) {
         ...
         if (class67.field917 != null) {
            for(var6 = 0; var6 < class482.field5330.length; ++var6) {
               if ((class482.field5330[var6] == var0 || var0 < class482.field5330[var6] && var1) && class476.field5295[var6] > 0) {
                  byte[] var4 = class67.field917[var6][--class476.field5295[var6]];
                  class67.field917[var6][class476.field5295[var6]] = null;
                  return var4;
               }
            }
         }

         if (var1 && class482.field5330 != null) {
            for(var6 = 0; var6 < class482.field5330.length; ++var6) {
               if (var0 <= class482.field5330[var6] && class476.field5295[var6] < class67.field917[var6].length) {
                  return new byte[class482.field5330[var6]];
               }
            }
         }
      }

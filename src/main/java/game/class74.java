   ...
   static final void method2409(class369[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      ...
      for(int var12 = var1; var12 <= var2; ++var12) {
         ...
         if (var13 != null && (var3 == var13.field4164 && var4 == var13.field4165 || var3 == -1412584499 && var13 == client.field612)) {
            int var14;
            if (var11 == -1) {
               client.field568[client.field563] = var9 + var13.field4158;
               client.field467[client.field563] = var10 + var13.field4204;
               client.field570[client.field563] = var13.field4160 * 469894397;
               client.field613[client.field563] = var13.field4149 * 1156037777;
               var14 = ++client.field563 - 1;
            } else {
               var14 = var11;
            }

            var13.field4293 = var14;
            var13.field4294 = client.field412;
               ...
               if (!var13.field4143 || var18 < var20 && var19 < var21) {
                  if (var13.field4168 != 0) {
                     if (var13.field4168 == 1336) {
                        if (class36.field239.method2562()) {
                           var16 += 15;
                     ...
                     if (var13.field4168 == 1400) {
                        class56.field816.method10708(var15, var16, var13.field4160 * 469894397, var13.field4149 * 1156037777, client.field412, class36.field239.method2566());
                     }
                     ...
                     if (var13.field4168 == 1402) {
                        class155.field1803.method2518(var15, client.field412);
                     }
                  }
                  ...
                  if (var13.field4147 == 0) {
                     ...
                     if (var13.field4145 * -217986249 == -1) {
                        ...
                        if (var32 != null) {
                           class164.method4007(var32.field888, var18, var19, var20, var21, var15, var16, var14);
                        }
                     }
                  ...
                  if (client.field431 || client.field356[var14] || client.field572 > 1) {
                           ...
                           if (var13.field4177) {
                              ...
                              default:
                                 if (var17 == 0) {
                                    ...
                                    class601.method11557(var15, var16, var13.field4160 * 469894397, var13.field4149 * 1156037777, var22, 256 - (var17 & 255));
                                 }
                              }
                           } else if (var17 == 0) {

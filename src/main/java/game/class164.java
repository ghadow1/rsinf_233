...
public class class164 extends class167 {
   ...
   void vmethod4108(class590 var1) {
      var1.method11196();
      this.field1880 = var1.method11198();
      this.field1879 = var1.method11197();
      this.field1881 = var1.method11198();
      var1.method11203();
   ...
   void vmethod4104(class171 var1) {
      class153 var2 = (class153)var1.field1918.get(this.field1880);
      var2.field1782 = this.field1879;
      var2.field1781 = this.field1881;
      var2.field1779 = new class613(this.field1882);
   }
   ...
   static final void method4007(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if (class119.field1554.method7478(var0)) {
         class152.field1777 = null;
         class74.method2409(class119.field1554.field4037[var0], 0, class119.field1554.field4037[var0].length - 1, -1, -1, var1, var2, var3, var4, var5, var6, var7);
         if (class152.field1777 != null) {
            class74.method2409(class152.field1777, 0, class152.field1777.length - 1, -1412584499, -1412584499, var1, var2, var3, var4, class163.field1872, class291.field3375, var7);
            class152.field1777 = null;
         }

      } else {
         if (var7 != -1) {
            client.field436[var7] = true;
         } else {
            for(int var8 = 0; var8 < 100; ++var8) {
               client.field436[var8] = true;
            }
         }

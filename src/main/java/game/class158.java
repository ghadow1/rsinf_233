...
public class class158 extends class151 {
   ...
   public static class176 method3879(int var0, class590 var1) {
      ...
      if (var5) {
         var7.field1950 = var1.method11198();
         var7.field1951 = var1.method11198();
      }

      if (var6) {
         var7.field1944 = var1.method11198();
         var7.field1952 = var1.method11198();
      }
   ...
   public static class209 method3882(int var0) {
      ...
      if (var1 != null) {
         ...
         var1 = new class209();
         if (var2 != null) {
            var1.method4544(new class590(var2));
         }

...
public enum class387 implements class430 {
   ...
   static final void method8199(class79 var0, boolean var1, class589 var2) {
      while(true) {
         byte var3 = 16;
         int var4 = 1 << var3;
         if (var2.method11167(client.field314.field1294) >= var3 + 12) {
            ...
            if (var5 != var4 - 1) {
               ...
               int var13 = client.field518[var2.method11146(3)];
               if (var6) {

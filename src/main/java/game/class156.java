...
public class class156 extends class151 {
   ...
   void vmethod4111(class590 var1) {
      this.field1809 = var1.method11202();
      this.field1810 = var1.method11202();
   ...
   static void method3864(class79 var0, class589 var1, int var2) {
      ...
      if (var3 > var0.field1176.method9790()) {
         ...
         while(var1.method11149(client.field314.field1294) > 0) {
            ...
            var11.method10074((class394)class173.method4100(var20, var1.method11196()));
            if (var2 >= 6) {

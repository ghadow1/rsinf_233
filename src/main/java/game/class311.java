      ...
      if (var7 != null) {
         ...
         if (var10) {
            if (class185.method4212(class388.method8204(var7), var6 - 1)) {
               class329 var9;
               if (var5 == 0) {
                  var9 = class130.method3593(class327.field3549, client.field314.field1308);
                  var9.field3664.writeIntBigEndian(var1);
                  var9.field3664.writeShortBigEndian(var2);
                  var9.field3664.writeShortBigEndian(var3);
                  var9.field3664.writeByte(var6);
                  client.field314.prepData(var9);
               } else {
                  var9 = class130.method3593(class327.field3640, client.field314.field1308);
                  var9.field3664.writeIntBigEndian(var1);
                  var9.field3664.writeShortBigEndian(var2);
                  var9.field3664.writeShortBigEndian(var3);
                  var9.field3664.writeByte(var6);
                  var9.field3664.writeByte(var5 - 1);
                  client.field314.prepData(var9);
               }

...
@ObfuscatedName("tz")
public class class516 implements class430 {
   @ObfuscatedName("af")
   @ObfuscatedSignature(
      descriptor = "Ltz;"
   )
   static final class516 field5483 = new class516(0, 0, 0, 0, 0, 0);
   @ObfuscatedName("aw")
   @ObfuscatedSignature(
      descriptor = "Ltz;"
   )
   public static final class516 field5485 = new class516(1, 1, 507, 507, 507, 507);
   @ObfuscatedName("at")
   @ObfuscatedSignature(
      descriptor = "Ltz;"
   )
   static final class516 field5475 = new class516(2, 2, 338, 338, 338, 507);
   @ObfuscatedName("ac")
   @ObfuscatedSignature(
      descriptor = "Ltz;"
   )
   static final class516 field5476 = new class516(3, 3, 499, 499, 499, 507);
   @ObfuscatedName("hi")
   @ObfuscatedSignature(
      descriptor = "Ldy;"
   )
   static class90 field5478;
   @ObfuscatedName("ap")
   @ObfuscatedGetter(
      intValue = 1045374039
   )
   ...
   public static void method10308(class519 var0, int var1, int var2) {
